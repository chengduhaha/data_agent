...
- `/workspace/source/contracts/{domain}/domain-knowledge.md`
- `/workspace/source/contracts/{domain}/metric-index.md`
- `/workspace/source/contracts/{domain}/eval/golden_cases.md` (when present)
- `/workspace/source/ref/{domain}/special_logic.txt`, `table list.txt`, `table relationship.txt` (when present for domain — always check `special_logic.txt` for the resolved table)
- `/workspace/target/storage/wkb/snapshots/_snapshot_id_template/l1_catalog/` (table/column metadata search)
- `/workspace/target/knowledgebase/{domain}/*.md` (table-level detail)

**Forbidden — NEVER use:**

- `/workspace/source/contracts/**/golden-questions.md`
- `/workspace/source/contracts/b-report-us/tables/**`, `/workspace/source/contracts/pos/tables/**`
...
`This question is outside the current contract scope. I can only answer business data questions that map to source/contracts domain and table knowledge. Please provide a metric, entity or analysis dimension, and an explicit time range or scope documented in the contracts.`
