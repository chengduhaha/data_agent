# -*- coding: utf-8 -*-
# @Time : 8/25/2023 4:29 PM
# @Author : Marvin Ma
# @File : dws_disty_brpt_part_comb_mtd.py
...
def exec_main_sql(country, date_flag, dt_month, etl_timestamp):
    ...
    insert overwrite table dw_{country}.dws_disty_brpt_part_comb_mtd partition(date_flag = '{date_flag}')
    select
        {month_no},
    ...
    coalesce(table_dwd.sku_no,-3) as sku_no,
    table_part.part_no,
    table_part.mfg_partno,
    coalesce(table_dwd.vpl_no,-3)                               as vpl_no,
    table_vpl.vpl_code                                          as vpl_code,
    coalesce(table_dwd.vpc_group_id,table_vpl.vpc_group_id,-3)  as vpc_group_id,
    ...
    table_dwd.seg_code                                               as seg_code,
    ...
    from (select *
          from dw_${country}.dws_disty_brpt_part_comb_mtd
