...
def exec_main_sql(country, date_flag, dt_month, etl_timestamp):
    ...
    insert overwrite table dm_${country}.dm_disty_brpt_buyer_comb_mtd partition(date_flag = '${date_flag}')
    select
        ${month_no},
...
def exec_newest_hierarchy(country, date_flag, dt_month):
    ...
    insert overwrite dm_{country}.dm_disty_brpt_buyer_comb_mtd partition(date_flag = '{date_flag}')
    select
        table_dm.month_no,
        nvl(table_dm.buyer_id,-3),
        table_dm.buyer_name,
        nvl(table_dm.buyer_mgr_id,-3),
        table_dm.buyer_mgr_name,
        nvl(table_dm.buyer_dir_id,-3),
        table_dm.buyer_dir_name,
        nvl(table_dm.buyer_vp_id,-3),
        table_dm.buyer_vp_name,
        table_dm.company_no,
    ...
    from (select *
          from dm_{country}.dm_disty_brpt_buyer_comb_mtd
          where date_flag = '{date_flag}') as table_dm
    left join table_last_dt_month
    on table_dm.buyer_id = table_last_dt_month.buyer_id
    and table_dm.buyer_mgr_id = table_last_dt_month.buyer_mgr_id
    and table_dm.buyer_dir_id = table_last_dt_month.buyer_dir_id
    and table_dm.buyer_vp_id = table_last_dt_month.buyer_vp_id
    and table_dm.company_no = table_last_dt_month.company_no
    
    left join table_dt_month_last_year
    on table_dm.buyer_id = table_dt_month_last_year.buyer_id
    and table_dm.buyer_mgr_id = table_dt_month_last_year.buyer_mgr_id
    and table_dm.buyer_dir_id = table_dt_month_last_year.buyer_dir_id
    and table_dm.buyer_vp_id = table_dt_month_last_year.buyer_vp_id
