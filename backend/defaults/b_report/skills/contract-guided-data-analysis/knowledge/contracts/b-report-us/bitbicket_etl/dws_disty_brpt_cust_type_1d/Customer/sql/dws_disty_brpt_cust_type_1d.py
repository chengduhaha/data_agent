...
# dw_${country}.dws_disty_brpt_terr_1d
...
def exec_sql():
    run_sql("""
    insert overwrite table dw_${country}.dws_disty_brpt_cust_type_1d partition(date_flag)
    select
        cust_type      ,
        cust_type_desc ,
        division       ,
        ...
        date_flag
    from dw_${country}.dws_disty_brpt_terr_1d
