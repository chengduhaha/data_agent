...
def main():
    ...
    run_sql("""
    insert overwrite table dw_${country}.dws_disty_brpt_part_wtd partition(dt_week)
    select
        ...
        sum(oplgm_plus_amt),
        table_dim.week_flag
    from (select * from dw_${country}.dws_disty_brpt_part_1d
