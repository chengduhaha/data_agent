...
run_sql("""
insert overwrite table dw_${country}.dwd_disty_brpt_orders_pl_di partition(date_flag,adjust_flag)
select 
    virtual_type,
    order_type,
    order_no,
    ...
    date_flag,
    adjust_flag
from (select * from dw_${country}.dwd_disty_brpt_orders_pl_di
      where date_flag between '${firstday_of_month}' and '${date_flag}') as a
