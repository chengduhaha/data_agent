# DWS: B Report profitability serving aggregation (mtd) by business slice (`dw_us.dws_disty_brpt_bd_vpl_mtd`)
...
- layer_type: DWS
- source_kind: etl_sql
- evidence_source: source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_vpl_mtd/BD/python/dws_disty_brpt_bd_vpl_mtd.py
- knowledgebase_path: target/knowledgebase/b-report-us/dws_disty_brpt_bd_vpl_mtd.md
- contract_source: source/contracts/b-report-us/tables/dws_disty_brpt_bd_vpl_mtd.md
...
|--------|---------|---------------|-------|
| Hive | yes | `dw_${country}.dws_disty_brpt_bd_vpl_mtd` | ETL target in Bitbucket script |
| Vertica | yes | `dw_us.dws_disty_brpt_bd_vpl_mtd` | Contract marks Vertica verified |

### Physical schema reference
| Field | Value |
|-------|-------|
| **Authoritative catalog** | WKB L1 storage seed (not duplicated in this file) |
| **entity_id** | `dw_us.dws_disty_brpt_bd_vpl_mtd` |
| **l1_catalog_seed** | `target/storage/wkb/snapshots/_snapshot_id_template/l1_catalog/vertica_dw_us_dws_disty_brpt_bd_vpl_mtd.json` |
| **column_count** | 127 |
| **partition_keys** | `month_no` |
| **ddl_source** | B Report contract catalog and/or VERTICA/vcdisty DDL |
| **retrieval** | `python -m tools.wkb.indexing.run_query --query "b-report-us dws_disty_brpt_bd_vpl_mtd schema" --intent find_table_schema` |

### Lineage
- **upstream:** Not parsed from ETL — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_vpl_mtd/BD/python/dws_disty_brpt_bd_vpl_mtd.py`
- **downstream:** B Report DM/DWS serving and dashboards (per contract L6 when present) — `source/contracts/b-report-us/tables/dws_disty_brpt_bd_vpl_mtd.md`
...
|---------------|-----------|---------|----------|
| — | — | No explicit JOIN clauses parsed | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_vpl_mtd/BD/python/dws_disty_brpt_bd_vpl_mtd.py` |
...
3. INSERT OVERWRITE into `dw_us.dws_disty_brpt_bd_vpl_mtd` partition `month_no`.
4. Sync to Vertica for B Report consumption (sync job not verified in this repository unless cited below).

```mermaid
flowchart LR
  dw_us_dws_disty_brpt_bd_vpl_mtd["dw_us.dws_disty_brpt_bd_vpl_mtd"]
  consumers["B Report dashboards / DM serving"]
  dw_us_dws_disty_brpt_bd_vpl_mtd --> consumers
```

### Base tables register
| Object | Role in this job |
|--------|------------------|
| `dw_us.dws_disty_brpt_bd_vpl_mtd` | target |
...
|------|--------|-----------------------------------------------------|
| 1 | `conf.get('date_flag')` | Business process date (comment: yesterday / @process_date) — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_vpl_mtd/BD/python/dws_disty_brpt_bd_vpl_mtd.py:12` |
| 3 | `conf.get('dt_month')` | Hive partition key `dt_month` (yyyy-MM derived from date_flag) — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_vpl_mtd/BD/python/dws_disty_brpt_bd_vpl_mtd.py:13` |
...
|------|-------------|----------------|-----------|----------|--------------|
| **Query for reporting** | `dw_us.dws_disty_brpt_bd_vpl_mtd` | `dw_us.dws_disty_brpt_bd_vpl_mtd` | overwrite / incremental | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_vpl_mtd/BD/python/dws_disty_brpt_bd_vpl_mtd.py` | yes |
| **Hive alternative** | `dw_us.dws_disty_brpt_bd_vpl_mtd` | same as reporting table | — | ETL target table | — |
| **ETL internal** | `dw_us.dws_disty_brpt_bd_vpl_mtd` | n/a | INSERT OVERWRITE | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_vpl_mtd/BD/python/dws_disty_brpt_bd_vpl_mtd.py` | — |
...
|--------|-------|----------|
| — | — | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_vpl_mtd/BD/python/dws_disty_brpt_bd_vpl_mtd.py` |

#### Downstream consumers (verified)
| Object / script | Evidence |
|-----------------|----------|
| B Report dashboards / sibling DM tables | `source/contracts/b-report-us/tables/dws_disty_brpt_bd_vpl_mtd.md:L6` |

#### Operational detail (verified)
- Load pattern: INSERT OVERWRITE (partitioned) per ETL SQL — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_vpl_mtd/BD/python/dws_disty_brpt_bd_vpl_mtd.py:21`
- ETL script path: `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_vpl_mtd/BD/python/dws_disty_brpt_bd_vpl_mtd.py`
...
- `dws_disty_brpt_bd_vpl_mtd.py` — primary Bitbucket ETL for `dws_disty_brpt_bd_vpl_mtd` — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_vpl_mtd/BD/python/dws_disty_brpt_bd_vpl_mtd.py`

---

*Document generated from `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_vpl_mtd/BD/python/dws_disty_brpt_bd_vpl_mtd.py` with B Report contract enrichment when available.*
