# DWS: B Report combined-month profitability serving slice (terr_comb_mtd) (`dw_us.dws_disty_brpt_terr_comb_mtd`)
...
- layer_type: DWS
- source_kind: etl_sql
- evidence_source: source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py
- knowledgebase_path: target/knowledgebase/b-report-us/dws_disty_brpt_terr_comb_mtd.md
- contract_source: source/contracts/b-report-us/tables/dws_disty_brpt_terr_comb_mtd.md
...
|--------|---------|---------------|-------|
| Hive | yes | `dw_${country}.dws_disty_brpt_terr_comb_mtd` | ETL target in Bitbucket script |
| Vertica | yes | `dw_us.dws_disty_brpt_terr_comb_mtd` | Contract marks Vertica verified |

### Physical schema reference
| Field | Value |
|-------|-------|
| **Authoritative catalog** | WKB L1 storage seed (not duplicated in this file) |
| **entity_id** | `dw_us.dws_disty_brpt_terr_comb_mtd` |
| **l1_catalog_seed** | `target/storage/wkb/snapshots/_snapshot_id_template/l1_catalog/vertica_dw_us_dws_disty_brpt_terr_comb_mtd.json` |
| **column_count** | 160 |
| **partition_keys** | `month_no` |
| **ddl_source** | B Report contract catalog and/or VERTICA/vcdisty DDL |
| **retrieval** | `python -m tools.wkb.indexing.run_query --query "b-report-us dws_disty_brpt_terr_comb_mtd schema" --intent find_table_schema` |

### Lineage
- **upstream:** dim_us.dim_pub_sales_mgr_dept_df, dim_us.dim_pub_sales_rep_terr_df, dim_us.dim_pub_sales_territory_df, dw_us.dwd_disty_sales_report_goal_view, dw_us.dws_disty_brpt_cust_comb_mtd, ods_us.ods_cis_corp_cust_type — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py`
- **downstream:** B Report DM/DWS serving and dashboards (per contract L6 when present) — `source/contracts/b-report-us/tables/dws_disty_brpt_terr_comb_mtd.md`
...
### Business purpose
B Report combined-month profitability serving slice (terr_comb_mtd)
...
|---------------|-----------|---------|----------|
| (ETL join) | — | left join (select * from dim_${country}.dim_pub_sales_territory_df | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py` |
...
3. INSERT OVERWRITE into `dw_us.dws_disty_brpt_terr_comb_mtd` partition `month_no`.
4. Sync to Vertica for B Report consumption (sync job not verified in this repository unless cited below).

```mermaid
flowchart LR
  dw_us_dws_disty_brpt_terr_comb_mtd["dw_us.dws_disty_brpt_terr_comb_mtd"]
  src0["dim_us.dim_pub_sales_mgr_dept_df"]
  src0 --> dw_us_dws_disty_brpt_terr_comb_mtd
  src1["dim_us.dim_pub_sales_rep_terr_df"]
  src1 --> dw_us_dws_disty_brpt_terr_comb_mtd
  src2["dim_us.dim_pub_sales_territory_df"]
  src2 --> dw_us_dws_disty_brpt_terr_comb_mtd
  src3["dw_us.dwd_disty_sales_report_goal_view"]
  src3 --> dw_us_dws_disty_brpt_terr_comb_mtd
  src4["dw_us.dws_disty_brpt_cust_comb_mtd"]
  src4 --> dw_us_dws_disty_brpt_terr_comb_mtd
  src5["ods_us.ods_cis_corp_cust_type"]
  src5 --> dw_us_dws_disty_brpt_terr_comb_mtd
  src6["ods_us.ods_cis_corp_division"]
  src6 --> dw_us_dws_disty_brpt_terr_comb_mtd
  src7["ods_us.ods_cis_corp_territory_group"]
  src7 --> dw_us_dws_disty_brpt_terr_comb_mtd
  consumers["B Report dashboards / DM serving"]
  dw_us_dws_disty_brpt_terr_comb_mtd --> consumers
```
...
| `dw_us.dws_disty_brpt_cust_comb_mtd` | source |
| `dw_us.dws_disty_brpt_terr_comb_mtd` | target |
...
**Source:** intermediate aggregation inside ETL SQL — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py`
...
|---------------|----------------|------------------|-----------------|----------------|----------|
| `month_no` | `${month_no}` | `month_no` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | partial | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:41` |
| `cust_terr` | `coalesce(table_dws.cust_terr,table_goal.cust_terr,-3)` | `cust_terr` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:222` |
| `terr_name` | `table_terr.terr_name` | `terr_name` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | passthrough | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:223` |
| `terr_sub_group` | `coalesce(table_dws.terr_sub_group, table_terr.sub_group_id,-3)` | `terr_sub_group`, `sub_group_id` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:224` |
| `sub_group_desc` | `table_sub_group.sub_group_desc` | `sub_group_desc` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | passthrough | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:225` |
| `terr_group` | `coalesce(table_dws.terr_group, table_terr.group_id,-3)` | `terr_group`, `group_id` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:226` |
| `terr_group_desc` | `table_group.group_desc` | `group_desc` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | rename | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:227` |
| `cust_type` | `coalesce(table_dws.cust_type,table_goal.cust_type,-3)` | `cust_type` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:228` |
| `cust_type_desc` | `table_cust_type.cust_type_descr` | `cust_type_descr` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | rename | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:229` |
| `division` | `coalesce(table_dws.division,table_goal.division,-3)` | `division` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:230` |
| `division_desc` | `table_div.division_desc` | `division_desc` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | passthrough | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:231` |
| `sales_rep_id` | `coalesce(table_dws.sales_rep_id ,table1.sales_rep_id,-3)` | `sales_rep_id` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:200` |
...
| `sales_dir_id` | `coalesce(table_dws.sales_dir_id ,table4.manager_id, -3)` | `sales_dir_id`, `manager_id` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:200` |
| `sales_vp_id` | `coalesce(table_dws.sales_vp_id ,table5.manager_id, -3)` | `sales_vp_id`, `manager_id` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:200` |
| `company_no` | `coalesce(table_dws.company_no,table_goal.company_no)` | `company_no` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:237` |
| `0` | `nvl(table_dws.d_sales,0)` | `d_sales` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:238` |
| `0` | `nvl(table_dws.d_cost,0)` | `d_cost` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:239` |
| `0` | `nvl(table_dws.d_unit,0)` | `d_unit` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:240` |
| `0` | `nvl(table_dws.d_gm,0)` | `d_gm` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:241` |
| `0` | `nvl(table_dws.d_ngm,0)` | `d_ngm` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:242` |
| `0` | `nvl(table_dws.d_opl,0)` | `d_opl` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:243` |
| `0` | `nvl(table_dws.d_scm_usage,0)` | `d_scm_usage` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:244` |
| `0` | `nvl(table_dws.d_tgm,0)` | `d_tgm` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:245` |
| `0` | `nvl(table_dws.d_cgp,0)` | `d_cgp` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:246` |
| `0` | `nvl(table_dws.d_total_btl,0)` | `d_total_btl` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:247` |
| `0` | `nvl(table_dws.w_sales,0)` | `w_sales` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:248` |
| `0` | `nvl(table_dws.w_cost,0)` | `w_cost` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:249` |
| `0` | `nvl(table_dws.w_unit,0)` | `w_unit` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:250` |
| `0` | `nvl(table_dws.w_gm,0)` | `w_gm` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:251` |
| `0` | `nvl(table_dws.w_ngm,0)` | `w_ngm` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:252` |
| `0` | `nvl(table_dws.w_opl,0)` | `w_opl` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:253` |
| `0` | `nvl(table_dws.w_scm_usage,0)` | `w_scm_usage` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:254` |
| `0` | `nvl(table_dws.w_tgm,0)` | `w_tgm` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:255` |
| `0` | `nvl(table_dws.w_cgp,0)` | `w_cgp` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:256` |
| `0` | `nvl(table_dws.w_total_btl,0)` | `w_total_btl` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:257` |
| `0` | `nvl(table_dws.m_sales,0)` | `m_sales` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:258` |
| `0` | `nvl(table_dws.m_cost,0)` | `m_cost` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:259` |
| `0` | `nvl(table_dws.m_unit,0)` | `m_unit` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:260` |
| `0` | `nvl(table_dws.m_gm,0)` | `m_gm` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:261` |
| `0` | `nvl(table_dws.m_ngm,0)` | `m_ngm` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:262` |
| `0` | `nvl(table_dws.m_opl,0)` | `m_opl` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:263` |
| `0` | `nvl(table_dws.m_scm_usage,0)` | `m_scm_usage` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:264` |
| `0` | `nvl(table_dws.m_tgm,0)` | `m_tgm` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:265` |
| `0` | `nvl(table_dws.m_scm_disc,0)` | `m_scm_disc` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:266` |
| `0` | `nvl(table_dws.m_scm_ndisc,0)` | `m_scm_ndisc` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:267` |
| `0` | `nvl(table_dws.m_ds_sales,0)` | `m_ds_sales` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:268` |
| `0` | `nvl(table_dws.m_stock_sales,0)` | `m_stock_sales` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:269` |
| `0` | `nvl(table_dws.m_ds_cost,0)` | `m_ds_cost` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:270` |
| `0` | `nvl(table_dws.m_stock_cost,0)` | `m_stock_cost` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:271` |
| `0` | `nvl(table_dws.m_ds_scm_usage,0)` | `m_ds_scm_usage` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:272` |
| `0` | `nvl(table_dws.m_stock_scm_usage,0)` | `m_stock_scm_usage` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:273` |
| `0` | `nvl(table_dws.m_cgp,0)` | `m_cgp` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:274` |
| `0` | `nvl(table_dws.m_total_btl,0)` | `m_total_btl` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:275` |
| `0` | `nvl(table_dws.pm_sales,0)` | `pm_sales` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:276` |
| `0` | `nvl(table_dws.pm_cost,0)` | `pm_cost` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:277` |
| `0` | `nvl(table_dws.pm_unit,0)` | `pm_unit` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:278` |
| `0` | `nvl(table_dws.pm_gm,0)` | `pm_gm` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:279` |
| `0` | `nvl(table_dws.pm_ngm,0)` | `pm_ngm` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:280` |
| `0` | `nvl(table_dws.pm_opl,0)` | `pm_opl` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:281` |
| `0` | `nvl(table_dws.pm_scm_usage,0)` | `pm_scm_usage` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:282` |
| `0` | `nvl(table_dws.pm_tgm,0)` | `pm_tgm` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:283` |
| `0` | `nvl(table_dws.pm_scm_disc,0)` | `pm_scm_disc` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:284` |
| `0` | `nvl(table_dws.pm_scm_ndisc,0)` | `pm_scm_ndisc` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:285` |
| `0` | `nvl(table_dws.pm_ds_sales,0)` | `pm_ds_sales` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:286` |
| `0` | `nvl(table_dws.pm_stock_sales,0)` | `pm_stock_sales` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:287` |
| `0` | `nvl(table_dws.pm_ds_cost,0)` | `pm_ds_cost` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:288` |
| `0` | `nvl(table_dws.pm_stock_cost,0)` | `pm_stock_cost` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:289` |
| `0` | `nvl(table_dws.pm_ds_scm_usage,0)` | `pm_ds_scm_usage` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:290` |
| `0` | `nvl(table_dws.pm_stock_scm_usage,0)` | `pm_stock_scm_usage` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:291` |
| `0` | `nvl(table_dws.pm_cgp,0)` | `pm_cgp` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:292` |
| `0` | `nvl(table_dws.pm_total_btl,0)` | `pm_total_btl` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:293` |
| `0` | `nvl(table_dws.ppm_sales,0)` | `ppm_sales` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:294` |
| `0` | `nvl(table_dws.ppm_cost,0)` | `ppm_cost` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:295` |
| `0` | `nvl(table_dws.ppm_unit,0)` | `ppm_unit` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:296` |
| `0` | `nvl(table_dws.ppm_gm,0)` | `ppm_gm` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:297` |
| `0` | `nvl(table_dws.ppm_ngm,0)` | `ppm_ngm` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:298` |
| `0` | `nvl(table_dws.ppm_opl,0)` | `ppm_opl` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:299` |
| `0` | `nvl(table_dws.ppm_scm_usage,0)` | `ppm_scm_usage` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:300` |

_Showing 80 of 159 columns; full list in L3 `*_column_derivations.json` sidecar._
...
|------|--------|-----------------------------------------------------|
| 1 | `conf.get('date_flag')` | Business process date (comment: yesterday / @process_date) — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:13` |
| 3 | `conf.get('dt_month')` | Hive partition key `dt_month` (yyyy-MM derived from date_flag) — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:14` |
...
|------|-------------|----------------|-----------|----------|--------------|
| **Query for reporting** | `dw_us.dws_disty_brpt_terr_comb_mtd` | `dw_us.dws_disty_brpt_terr_comb_mtd` | overwrite / incremental | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py` | yes |
| **Hive alternative** | `dw_us.dws_disty_brpt_terr_comb_mtd` | same as reporting table | — | ETL target table | — |
| **ETL internal** | `dw_us.dws_disty_brpt_terr_comb_mtd` | n/a | INSERT OVERWRITE | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py` | — |
...
|--------|-------|----------|
| `dim_us.dim_pub_sales_mgr_dept_df` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py` |
| `dim_us.dim_pub_sales_rep_terr_df` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py` |
| `dim_us.dim_pub_sales_territory_df` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py` |
| `dw_us.dwd_disty_sales_report_goal_view` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py` |
| `dw_us.dws_disty_brpt_cust_comb_mtd` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py` |
| `ods_us.ods_cis_corp_cust_type` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py` |
| `ods_us.ods_cis_corp_division` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py` |
| `ods_us.ods_cis_corp_territory_group` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py` |
| `ods_us.ods_cis_corp_territory_sub_group` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py` |

#### Downstream consumers (verified)
| Object / script | Evidence |
|-----------------|----------|
| B Report dashboards / sibling DM tables | `source/contracts/b-report-us/tables/dws_disty_brpt_terr_comb_mtd.md:L6` |

#### Operational detail (verified)
- Load pattern: INSERT OVERWRITE (partitioned) per ETL SQL — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py:219`
- ETL script path: `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py`
...
- `dws_disty_brpt_terr_comb_mtd.py` — primary Bitbucket ETL for `dws_disty_brpt_terr_comb_mtd` — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py`

---

*Document generated from `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_comb_mtd/Customer/python/dws_disty_brpt_terr_comb_mtd.py` with B Report contract enrichment when available.*
