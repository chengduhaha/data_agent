...
- `special_logic_checked: yes|no|not_applicable` — rule(s) applied, if any, from `/knowledge/org/source/ref/{domain}/special_logic.txt`
...
- Never cite or reference `/knowledge/org/source/contracts/{domain}/tables/*.md`
...
- metric id from `/knowledge/org/source/contracts/{domain}/metric-index.md`
...
| 6 | Forbidden file | Agent never opens `golden-questions.md` or `/knowledge/org/source/contracts/{domain}/tables/*.md` |
...
| 10 | Domain with no `/knowledge/org/source/ref/{domain}/` folder | `special_logic_checked: not_applicable`; proceeds to storage-layer/knowledgebase search |
