# Catalog object: `dim_us.dim_pub_terms_file_view`

- artifact_type: etl_table
- artifact_id: dim_us.dim_pub_terms_file_view
- domain: pos
...
- **Table:** `dim_us.dim_pub_terms_file_view`
...
| Field | Value |
|-------|-------|
| **entity_id** | `dim_us.dim_pub_terms_file_view` |
| **l1_catalog_seed** | `target/storage/wkb/snapshots/_snapshot_id_template/l1_catalog/{engine}_{schema}_{table}.json` |
| **column_count** | pending |
| **partition_keys** | See preserved Grain |
| **ddl_source** | pending |
| **retrieval** | `python -m tools.wkb.indexing.run_query --query "pos dim_pub_terms_file_view schema" --intent find_table_schema` |

### Lineage
- **Load ETL in wiki repo:** Not documented in repository (`source/contracts/pos/bitbucket-etl/dim_pub_terms_file_view/` absent)
- **Cross-project consumers:** see L6 (4 verified script hit(s))
...
- Prefer Vertica `dim_us.dim_pub_terms_file_view` for reporting when contract documents Vertica sync.
...
```mermaid
flowchart LR
  CONTRACT["POS contract catalog"] --> T["dim_us.dim_pub_terms_file_view"]
...
### Step-by-step logic
1. No bitbucket-etl bundle for `dim_pub_terms_file_view` in this repository.
2. Consumers that reference `dim_pub_terms_file_view` are listed under L6 when found by repo scan.
...
|-----------------|----------|
| ETL/script consumer | `source/contracts/rds/vertica_inventory/etl/inv_rollover_true_aging_rds_10968.sql:555` |
| ETL/script consumer | `source/contracts/rds/vertica_ar/etl/ar_discount_payment_timing_rds_19383.sql:57` |
| ETL/script consumer | `source/contracts/rds/vertica_ar/etl/ar_open_aging_customer_activity_credit_limit_rds_11417.sql:155` |
| ETL/script consumer | `source/contracts/rds/vertica_ap/etl/ap_forecast_payment_receipt_open_po_rds_1545.sql:36` |

#### Operational detail (verified)
- No `source/contracts/pos/bitbucket-etl/dim_pub_terms_file_view/` bundle in this repository.
