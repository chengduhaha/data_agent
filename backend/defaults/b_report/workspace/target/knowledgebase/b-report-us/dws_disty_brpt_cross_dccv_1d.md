...
**Domain:** b-report-us  
**Source contract:** `source/contracts/b-report-us/tables/dws_disty_brpt_cross_dccv_1d.md`  
**Knowledgebase path:** `target/knowledgebase/b-report-us/dws_disty_brpt_cross_dccv_1d.md`
...
|-------|------------------|
| **Catalog object** | `dw_us.dws_disty_brpt_cross_dccv_1d` — DWS layer table used in US B Report analytics (`US B Report baseline`). |
...
|------|-------------|----------------|-----------|----------|--------------|
| **Query for reporting** | `dw_us.dws_disty_brpt_cross_dccv_1d` | `dw_us.dws_disty_brpt_cross_dccv_1d` | overwrite / incremental | B Report contract `dws_disty_brpt_cross_dccv_1d.md:L1` | yes (B Report contract v2 — Vertica verified in source catalog) |
| **Hive alternative** | `dw_us.dws_disty_brpt_cross_dccv_1d` | same as reporting table | - | B Report contract cross-engine note | - |
| **ETL internal** | n/a | n/a | - | ETL not in wiki repo | - |

Business users should query **`dw_us.dws_disty_brpt_cross_dccv_1d`** in Vertica for B Report reporting aligned to this contract.
...
- **Natural key:** `vend_no`, `master_vend_no`, `company_no`
...
**Target table:** `dw_us.dws_disty_brpt_cross_dccv_1d`  
...
flowchart LR
  ...
  tgt["dw_us.dws_disty_brpt_cross_dccv_1d"]
...
|--------|-----------------|
| `dw_us.dws_disty_brpt_cross_dccv_1d` | Primary catalog table documented from B Report contract |
...
|--------|-------|----------|
| B Report contract source | Table metadata, grain, columns | `source/contracts/b-report-us/tables/dws_disty_brpt_cross_dccv_1d.md` |

### Downstream consumers (verified)

| Object / script | Evidence |
|-----------------|----------|
| B Report consumers | `dws_disty_brpt_cross_dccv_1d.md:L6` — see contract L6 |
...
*Document generated from B Report contract `source/contracts/b-report-us/tables/dws_disty_brpt_cross_dccv_1d.md`.*
