# DWS: B Report combined-month profitability serving slice (division_comb_mtd) (`dw_us.dws_disty_brpt_division_comb_mtd`)
...
- layer_type: DWS
- source_kind: etl_sql
- evidence_source: source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py
- knowledgebase_path: target/knowledgebase/b-report-us/dws_disty_brpt_division_comb_mtd.md
- contract_source: source/contracts/b-report-us/tables/dws_disty_brpt_division_comb_mtd.md
...
|--------|---------|---------------|-------|
| Hive | yes | `dw_${country}.dws_disty_brpt_division_comb_mtd` | ETL target in Bitbucket script |
| Vertica | yes | `dw_us.dws_disty_brpt_division_comb_mtd` | Contract marks Vertica verified |

### Physical schema reference
| Field | Value |
|-------|-------|
| **Authoritative catalog** | WKB L1 storage seed (not duplicated in this file) |
| **entity_id** | `dw_us.dws_disty_brpt_division_comb_mtd` |
| **l1_catalog_seed** | `target/storage/wkb/snapshots/_snapshot_id_template/l1_catalog/vertica_dw_us_dws_disty_brpt_division_comb_mtd.json` |
| **column_count** | 147 |
| **partition_keys** | `month_no` |
| **ddl_source** | B Report contract catalog and/or VERTICA/vcdisty DDL |
| **retrieval** | `python -m tools.wkb.indexing.run_query --query "b-report-us dws_disty_brpt_division_comb_mtd schema" --intent find_table_schema` |

### Lineage
- **upstream:** dw_us.dwd_disty_sales_report_goal_view, dw_us.dws_disty_brpt_cust_type_comb_mtd, ods_us.ods_cis_corp_division — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py`
- **downstream:** B Report DM/DWS serving and dashboards (per contract L6 when present) — `source/contracts/b-report-us/tables/dws_disty_brpt_division_comb_mtd.md`
...
### Business purpose
B Report combined-month profitability serving slice (division_comb_mtd)
...
|---------------|-----------|---------|----------|
| — | — | No explicit JOIN clauses parsed | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py` |
...
### End-to-end flow
1. Read upstream warehouse objects (dw_us.dwd_disty_sales_report_goal_view, dw_us.dws_disty_brpt_cust_type_comb_mtd, ods_us.ods_cis_corp_division).
2. Apply CTE aggregations and business joins inside ETL SQL.
3. INSERT OVERWRITE into `dw_us.dws_disty_brpt_division_comb_mtd` partition `month_no`.
4. Sync to Vertica for B Report consumption (sync job not verified in this repository unless cited below).

```mermaid
flowchart LR
  dw_us_dws_disty_brpt_division_comb_mtd["dw_us.dws_disty_brpt_division_comb_mtd"]
  src0["dw_us.dwd_disty_sales_report_goal_view"]
  src0 --> dw_us_dws_disty_brpt_division_comb_mtd
  src1["dw_us.dws_disty_brpt_cust_type_comb_mtd"]
  src1 --> dw_us_dws_disty_brpt_division_comb_mtd
  src2["ods_us.ods_cis_corp_division"]
  src2 --> dw_us_dws_disty_brpt_division_comb_mtd
  consumers["B Report dashboards / DM serving"]
  dw_us_dws_disty_brpt_division_comb_mtd --> consumers
```
...
| `dw_us.dws_disty_brpt_cust_type_comb_mtd` | source |
| `dw_us.dws_disty_brpt_division_comb_mtd` | target |
| `ods_us.ods_cis_corp_division` | source |

### Step-by-step logic
#### Step 1 — CTE `table_goal`

**Source:** intermediate aggregation inside ETL SQL — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py`
...
|---------------|----------------|------------------|-----------------|----------------|----------|
| `month_no` | `${month_no}` | `month_no` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | partial | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:40` |
| `3` | `coalesce(table_dws.division,table_goal.division,-3)` | `division` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:205` |
| `division_desc` | `table_div.division_desc` | `division_desc` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | passthrough | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:206` |
| `company_no` | `coalesce(table_dws.company_no,table_goal.company_no)` | `company_no` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:207` |
| `0` | `nvl(table_dws.d_sales,0)` | `d_sales` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:208` |
| `0` | `nvl(table_dws.d_cost,0)` | `d_cost` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:209` |
| `0` | `nvl(table_dws.d_unit,0)` | `d_unit` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:210` |
| `0` | `nvl(table_dws.d_gm,0)` | `d_gm` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:211` |
| `0` | `nvl(table_dws.d_ngm,0)` | `d_ngm` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:212` |
| `0` | `nvl(table_dws.d_opl,0)` | `d_opl` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:213` |
| `0` | `nvl(table_dws.d_scm_usage,0)` | `d_scm_usage` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:214` |
| `0` | `nvl(table_dws.d_tgm,0)` | `d_tgm` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:215` |
| `0` | `nvl(table_dws.d_cgp,0)` | `d_cgp` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:216` |
| `0` | `nvl(table_dws.d_total_btl,0)` | `d_total_btl` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:217` |
| `0` | `nvl(table_dws.w_sales,0)` | `w_sales` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:218` |
| `0` | `nvl(table_dws.w_cost,0)` | `w_cost` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:219` |
| `0` | `nvl(table_dws.w_unit,0)` | `w_unit` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:220` |
| `0` | `nvl(table_dws.w_gm,0)` | `w_gm` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:221` |
| `0` | `nvl(table_dws.w_ngm,0)` | `w_ngm` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:222` |
| `0` | `nvl(table_dws.w_opl,0)` | `w_opl` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:223` |
| `0` | `nvl(table_dws.w_scm_usage,0)` | `w_scm_usage` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:224` |
| `0` | `nvl(table_dws.w_tgm,0)` | `w_tgm` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:225` |
| `0` | `nvl(table_dws.w_cgp,0)` | `w_cgp` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:226` |
| `0` | `nvl(table_dws.w_total_btl,0)` | `w_total_btl` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:227` |
| `0` | `nvl(table_dws.m_sales,0)` | `m_sales` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:228` |
| `0` | `nvl(table_dws.m_cost,0)` | `m_cost` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:229` |
| `0` | `nvl(table_dws.m_unit,0)` | `m_unit` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:230` |
| `0` | `nvl(table_dws.m_gm,0)` | `m_gm` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:231` |
| `0` | `nvl(table_dws.m_ngm,0)` | `m_ngm` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:232` |
| `0` | `nvl(table_dws.m_opl,0)` | `m_opl` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:233` |
| `0` | `nvl(table_dws.m_scm_usage,0)` | `m_scm_usage` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:234` |
| `0` | `nvl(table_dws.m_tgm,0)` | `m_tgm` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:235` |
| `0` | `nvl(table_dws.m_scm_disc,0)` | `m_scm_disc` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:236` |
| `0` | `nvl(table_dws.m_scm_ndisc,0)` | `m_scm_ndisc` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:237` |
| `0` | `nvl(table_dws.m_ds_sales,0)` | `m_ds_sales` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:238` |
| `0` | `nvl(table_dws.m_stock_sales,0)` | `m_stock_sales` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:239` |
| `0` | `nvl(table_dws.m_ds_cost,0)` | `m_ds_cost` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:240` |
| `0` | `nvl(table_dws.m_stock_cost,0)` | `m_stock_cost` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:241` |
| `0` | `nvl(table_dws.m_ds_scm_usage,0)` | `m_ds_scm_usage` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:242` |
| `0` | `nvl(table_dws.m_stock_scm_usage,0)` | `m_stock_scm_usage` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:243` |
| `0` | `nvl(table_dws.m_cgp,0)` | `m_cgp` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:244` |
| `0` | `nvl(table_dws.m_total_btl,0)` | `m_total_btl` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:245` |
| `0` | `nvl(table_dws.pm_sales,0)` | `pm_sales` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:246` |
| `0` | `nvl(table_dws.pm_cost,0)` | `pm_cost` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:247` |
| `0` | `nvl(table_dws.pm_unit,0)` | `pm_unit` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:248` |
| `0` | `nvl(table_dws.pm_gm,0)` | `pm_gm` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:249` |
| `0` | `nvl(table_dws.pm_ngm,0)` | `pm_ngm` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:250` |
| `0` | `nvl(table_dws.pm_opl,0)` | `pm_opl` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:251` |
| `0` | `nvl(table_dws.pm_scm_usage,0)` | `pm_scm_usage` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:252` |
| `0` | `nvl(table_dws.pm_tgm,0)` | `pm_tgm` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:253` |
| `0` | `nvl(table_dws.pm_scm_disc,0)` | `pm_scm_disc` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:254` |
| `0` | `nvl(table_dws.pm_scm_ndisc,0)` | `pm_scm_ndisc` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:255` |
| `0` | `nvl(table_dws.pm_ds_sales,0)` | `pm_ds_sales` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:256` |
| `0` | `nvl(table_dws.pm_stock_sales,0)` | `pm_stock_sales` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:257` |
| `0` | `nvl(table_dws.pm_ds_cost,0)` | `pm_ds_cost` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:258` |
| `0` | `nvl(table_dws.pm_stock_cost,0)` | `pm_stock_cost` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:259` |
| `0` | `nvl(table_dws.pm_ds_scm_usage,0)` | `pm_ds_scm_usage` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:260` |
| `0` | `nvl(table_dws.pm_stock_scm_usage,0)` | `pm_stock_scm_usage` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:261` |
| `0` | `nvl(table_dws.pm_cgp,0)` | `pm_cgp` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:262` |
| `0` | `nvl(table_dws.pm_total_btl,0)` | `pm_total_btl` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:263` |
| `0` | `nvl(table_dws.ppm_sales,0)` | `ppm_sales` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:264` |
| `0` | `nvl(table_dws.ppm_cost,0)` | `ppm_cost` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:265` |
| `0` | `nvl(table_dws.ppm_unit,0)` | `ppm_unit` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:266` |
| `0` | `nvl(table_dws.ppm_gm,0)` | `ppm_gm` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:267` |
| `0` | `nvl(table_dws.ppm_ngm,0)` | `ppm_ngm` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:268` |
| `0` | `nvl(table_dws.ppm_opl,0)` | `ppm_opl` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:269` |
| `0` | `nvl(table_dws.ppm_scm_usage,0)` | `ppm_scm_usage` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:270` |
| `0` | `nvl(table_dws.ppm_tgm,0)` | `ppm_tgm` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:271` |
| `0` | `nvl(table_dws.ppm_scm_disc,0)` | `ppm_scm_disc` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:272` |
| `0` | `nvl(table_dws.ppm_scm_ndisc,0)` | `ppm_scm_ndisc` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:273` |
| `0` | `nvl(table_dws.ppm_ds_sales,0)` | `ppm_ds_sales` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:274` |
| `0` | `nvl(table_dws.ppm_stock_sales,0)` | `ppm_stock_sales` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:275` |
| `0` | `nvl(table_dws.ppm_ds_cost,0)` | `ppm_ds_cost` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:276` |
| `0` | `nvl(table_dws.ppm_stock_cost,0)` | `ppm_stock_cost` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:277` |
| `0` | `nvl(table_dws.ppm_ds_scm_usage,0)` | `ppm_ds_scm_usage` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:278` |
| `0` | `nvl(table_dws.ppm_stock_scm_usage,0)` | `ppm_stock_scm_usage` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:279` |
| `0` | `nvl(table_dws.ppm_cgp,0)` | `ppm_cgp` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:280` |
| `0` | `nvl(table_dws.ppm_total_btl,0)` | `ppm_total_btl` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:281` |
| `0` | `nvl(table_dws.lm_sales,0)` | `lm_sales` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:282` |
| `0` | `nvl(table_dws.lm_cost,0)` | `lm_cost` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_division` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:283` |

_Showing 80 of 146 columns; full list in L3 `*_column_derivations.json` sidecar._
...
|------|--------|-----------------------------------------------------|
| 1 | `conf.get('date_flag')` | Business process date (comment: yesterday / @process_date) — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:14` |
| 3 | `conf.get('dt_month')` | Hive partition key `dt_month` (yyyy-MM derived from date_flag) — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:15` |
...
|------|-------------|----------------|-----------|----------|--------------|
| **Query for reporting** | `dw_us.dws_disty_brpt_division_comb_mtd` | `dw_us.dws_disty_brpt_division_comb_mtd` | overwrite / incremental | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py` | yes |
| **Hive alternative** | `dw_us.dws_disty_brpt_division_comb_mtd` | same as reporting table | — | ETL target table | — |
| **ETL internal** | `dw_us.dws_disty_brpt_division_comb_mtd` | n/a | INSERT OVERWRITE | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py` | — |
...
|--------|-------|----------|
| `dw_us.dwd_disty_sales_report_goal_view` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py` |
| `dw_us.dws_disty_brpt_cust_type_comb_mtd` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py` |
| `ods_us.ods_cis_corp_division` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py` |

#### Downstream consumers (verified)
| Object / script | Evidence |
|-----------------|----------|
| B Report dashboards / sibling DM tables | `source/contracts/b-report-us/tables/dws_disty_brpt_division_comb_mtd.md:L6` |

#### Operational detail (verified)
- Load pattern: INSERT OVERWRITE (partitioned) per ETL SQL — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py:202`
- ETL script path: `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py`
...
- `dws_disty_brpt_division_comb_mtd.py` — primary Bitbucket ETL for `dws_disty_brpt_division_comb_mtd` — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py`

---

*Document generated from `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_division_comb_mtd/Customer/python/dws_disty_brpt_division_comb_mtd.py` with B Report contract enrichment when available.*
