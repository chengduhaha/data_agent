# DM: B Report profitability serving aggregation (mtd) by business slice (`dm_us.dm_disty_brpt_buyer_mtd`)
...
- layer_type: DM
- source_kind: etl_sql
- evidence_source: source/contracts/b-report-us/bitbicket_etl/dm_disty_brpt_buyer_mtd/Product/python/dm_disty_brpt_buyer_mtd.py
- knowledgebase_path: target/knowledgebase/b-report-us/dm_disty_brpt_buyer_mtd.md
- contract_source: source/contracts/b-report-us/tables/dm_disty_brpt_buyer_mtd.md
...
|--------|---------|---------------|-------|
| Hive | yes | `dm_${country}.dm_disty_brpt_buyer_mtd` | ETL target in Bitbucket script |
| Vertica | yes | `dm_us.dm_disty_brpt_buyer_mtd` | Contract marks Vertica verified |

### Physical schema reference
| Field | Value |
|-------|-------|
| **Authoritative catalog** | WKB L1 storage seed (not duplicated in this file) |
| **entity_id** | `dm_us.dm_disty_brpt_buyer_mtd` |
| **l1_catalog_seed** | `target/storage/wkb/snapshots/_snapshot_id_template/l1_catalog/vertica_dm_us_dm_disty_brpt_buyer_mtd.json` |
| **column_count** | 138 |
| **partition_keys** | `month_no` |
| **ddl_source** | B Report contract catalog and/or VERTICA/vcdisty DDL |
| **retrieval** | `python -m tools.wkb.indexing.run_query --query "b-report-us dm_disty_brpt_buyer_mtd schema" --intent find_table_schema` |

### Lineage
- **upstream:** Not parsed from ETL — `source/contracts/b-report-us/bitbicket_etl/dm_disty_brpt_buyer_mtd/Product/python/dm_disty_brpt_buyer_mtd.py`
- **downstream:** B Report DM/DWS serving and dashboards (per contract L6 when present) — `source/contracts/b-report-us/tables/dm_disty_brpt_buyer_mtd.md`
...
|---------------|-----------|---------|----------|
| — | — | No explicit JOIN clauses parsed | `source/contracts/b-report-us/bitbicket_etl/dm_disty_brpt_buyer_mtd/Product/python/dm_disty_brpt_buyer_mtd.py` |
...
3. INSERT OVERWRITE into `dm_us.dm_disty_brpt_buyer_mtd` partition `month_no`.
4. Sync to Vertica for B Report consumption (sync job not verified in this repository unless cited below).

```mermaid
flowchart LR
  dm_us_dm_disty_brpt_buyer_mtd["dm_us.dm_disty_brpt_buyer_mtd"]
  consumers["B Report dashboards / DM serving"]
  dm_us_dm_disty_brpt_buyer_mtd --> consumers
```

### Base tables register
| Object | Role in this job |
|--------|------------------|
| `dm_us.dm_disty_brpt_buyer_mtd` | target |
...
|------|--------|-----------------------------------------------------|
| 1 | `conf.get('date_flag')` | Business process date (comment: yesterday / @process_date) — `source/contracts/b-report-us/bitbicket_etl/dm_disty_brpt_buyer_mtd/Product/python/dm_disty_brpt_buyer_mtd.py:10` |
| 3 | `conf.get('dt_month')` | Hive partition key `dt_month` (yyyy-MM derived from date_flag) — `source/contracts/b-report-us/bitbicket_etl/dm_disty_brpt_buyer_mtd/Product/python/dm_disty_brpt_buyer_mtd.py:19` |
...
|------|-------------|----------------|-----------|----------|--------------|
| **Query for reporting** | `dm_us.dm_disty_brpt_buyer_mtd` | `dm_us.dm_disty_brpt_buyer_mtd` | overwrite / incremental | `source/contracts/b-report-us/bitbicket_etl/dm_disty_brpt_buyer_mtd/Product/python/dm_disty_brpt_buyer_mtd.py` | yes |
| **Hive alternative** | `dm_us.dm_disty_brpt_buyer_mtd` | same as reporting table | — | ETL target table | — |
| **ETL internal** | `dm_us.dm_disty_brpt_buyer_mtd` | n/a | INSERT OVERWRITE | `source/contracts/b-report-us/bitbicket_etl/dm_disty_brpt_buyer_mtd/Product/python/dm_disty_brpt_buyer_mtd.py` | — |
...
|--------|-------|----------|
| — | — | `source/contracts/b-report-us/bitbicket_etl/dm_disty_brpt_buyer_mtd/Product/python/dm_disty_brpt_buyer_mtd.py` |

#### Downstream consumers (verified)
| Object / script | Evidence |
|-----------------|----------|
| B Report dashboards / sibling DM tables | `source/contracts/b-report-us/tables/dm_disty_brpt_buyer_mtd.md:L6` |

#### Operational detail (verified)
- Load pattern: INSERT OVERWRITE (partitioned) per ETL SQL — `source/contracts/b-report-us/bitbicket_etl/dm_disty_brpt_buyer_mtd/Product/python/dm_disty_brpt_buyer_mtd.py:179`
- ETL script path: `source/contracts/b-report-us/bitbicket_etl/dm_disty_brpt_buyer_mtd/Product/python/dm_disty_brpt_buyer_mtd.py`
...
- `dm_disty_brpt_buyer_mtd.py` — primary Bitbucket ETL for `dm_disty_brpt_buyer_mtd` — `source/contracts/b-report-us/bitbicket_etl/dm_disty_brpt_buyer_mtd/Product/python/dm_disty_brpt_buyer_mtd.py`

---

*Document generated from `source/contracts/b-report-us/bitbicket_etl/dm_disty_brpt_buyer_mtd/Product/python/dm_disty_brpt_buyer_mtd.py` with B Report contract enrichment when available.*
