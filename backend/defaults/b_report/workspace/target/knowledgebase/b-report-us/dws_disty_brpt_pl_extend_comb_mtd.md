# DWS: B Report combined-month profitability serving slice (pl_extend_comb_mtd) (`dw_us.dws_disty_brpt_pl_extend_comb_mtd`)
...
- layer_type: DWS
- source_kind: etl_sql
- evidence_source: source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py
- knowledgebase_path: target/knowledgebase/b-report-us/dws_disty_brpt_pl_extend_comb_mtd.md
- contract_source: source/contracts/b-report-us/tables/dws_disty_brpt_pl_extend_comb_mtd.md
...
|--------|---------|---------------|-------|
| Hive | yes | `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd` | ETL target in Bitbucket script |
| Vertica | yes | `dw_us.dws_disty_brpt_pl_extend_comb_mtd` | Contract marks Vertica verified |

### Physical schema reference
| Field | Value |
|-------|-------|
| **Authoritative catalog** | WKB L1 storage seed (not duplicated in this file) |
| **entity_id** | `dw_us.dws_disty_brpt_pl_extend_comb_mtd` |
| **l1_catalog_seed** | `target/storage/wkb/snapshots/_snapshot_id_template/l1_catalog/vertica_dw_us_dws_disty_brpt_pl_extend_comb_mtd.json` |
| **column_count** | 176 |
| **partition_keys** | `month_no` |
| **ddl_source** | B Report contract catalog and/or VERTICA/vcdisty DDL |
| **retrieval** | `python -m tools.wkb.indexing.run_query --query "b-report-us dws_disty_brpt_pl_extend_comb_mtd schema" --intent find_table_schema` |

### Lineage
- **upstream:** dim_us.dim_pub_customer_info_df, dim_us.dim_pub_part_info_df, dim_us.dim_pub_sales_mgr_dept_df, dim_us.dim_pub_sales_rep_terr_df, dim_us.dim_pub_sales_territory_df, dim_us.dim_pub_vendor_info_df — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py`
- **downstream:** B Report DM/DWS serving and dashboards (per contract L6 when present) — `source/contracts/b-report-us/tables/dws_disty_brpt_pl_extend_comb_mtd.md`
...
### Business purpose
B Report combined-month profitability serving slice (pl_extend_comb_mtd)
...
|---------------|-----------|---------|----------|
| (ETL join) | — | left join (select * from temp_cust_xref_company | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py` |
| (ETL join) | — | left join (select * from dim_${country}.dim_pub_sales_territory_df | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py` |

### Key filters and ETL business logic
- `date_flag = '${date_flag}'` — inferred from ETL WHERE clause
- `date_flag in ('${end_day_of_last_2month}','${end_day_of_last_month}')` — inferred from ETL WHERE clause
- `date_flag = '${end_day_of_same_month_of_last_year}'` — inferred from ETL WHERE clause
- `date_flag between '${week_begin_of_dateflag}' and '${date_flag}'` — inferred from ETL WHERE clause
...
### End-to-end flow
1. Read upstream warehouse objects (dim_us.dim_pub_customer_info_df, dim_us.dim_pub_part_info_df, dim_us.dim_pub_sales_mgr_dept_df, dim_us.dim_pub_sales_rep_terr_df).
2. Apply CTE aggregations and business joins inside ETL SQL.
3. INSERT OVERWRITE into `dw_us.dws_disty_brpt_pl_extend_comb_mtd` partition `month_no`.
4. Sync to Vertica for B Report consumption (sync job not verified in this repository unless cited below).

```mermaid
flowchart LR
  dw_us_dws_disty_brpt_pl_extend_comb_mtd["dw_us.dws_disty_brpt_pl_extend_comb_mtd"]
  src0["dim_us.dim_pub_customer_info_df"]
  src0 --> dw_us_dws_disty_brpt_pl_extend_comb_mtd
  src1["dim_us.dim_pub_part_info_df"]
  src1 --> dw_us_dws_disty_brpt_pl_extend_comb_mtd
  src2["dim_us.dim_pub_sales_mgr_dept_df"]
  src2 --> dw_us_dws_disty_brpt_pl_extend_comb_mtd
  src3["dim_us.dim_pub_sales_rep_terr_df"]
  src3 --> dw_us_dws_disty_brpt_pl_extend_comb_mtd
  src4["dim_us.dim_pub_sales_territory_df"]
  src4 --> dw_us_dws_disty_brpt_pl_extend_comb_mtd
  src5["dim_us.dim_pub_vendor_info_df"]
  src5 --> dw_us_dws_disty_brpt_pl_extend_comb_mtd
  src6["dim_us.dim_pub_vpl_hierarchy_info_df"]
  src6 --> dw_us_dws_disty_brpt_pl_extend_comb_mtd
  src7["dim_us.dim_pub_vpl_info_df"]
  src7 --> dw_us_dws_disty_brpt_pl_extend_comb_mtd
  consumers["B Report dashboards / DM serving"]
  dw_us_dws_disty_brpt_pl_extend_comb_mtd --> consumers
```
...
| `dw_us.dws_disty_brpt_pl_extend_comb_mtd` | target |
...
### Step-by-step logic
#### Step 1 — CTE `table_dt_month`

**Source:** intermediate aggregation inside ETL SQL — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py`

#### Step 2 — CTE `table_last_dt_month`

**Source:** intermediate aggregation inside ETL SQL — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py`

#### Step 3 — CTE `table_dt_month_last_year`
...
#### Step 5 — dimension and reference joins
...
|---------------|----------------|------------------|-----------------|----------------|----------|
| `month_no` | `${month_no}` | `month_no` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | partial | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:289` |
| `cust_no` | `coalesce(table_dt_month.cust_no, table_last_dt_month.cust_no, table_dt_month_last_year.cust_no,table_1d.cust_no)` | `cust_no` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:290` |
| `cust_name` | `null` | — | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | rename | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:291` |
| `mcust_no` | `mcust_no` | `mcust_no` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | passthrough | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:25` |
| `mcust_name` | `null` | — | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | rename | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:291` |
| `cust_terr` | `coalesce(table_dt_month.cust_terr, table_last_dt_month.cust_terr, table_dt_month_last_year.cust_terr,table_1d.cust_terr)` | `cust_terr` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:294` |
| `terr_name` | `null` | — | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | rename | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:291` |
| `cust_type` | `coalesce(table_dt_month.cust_type, table_last_dt_month.cust_type, table_dt_month_last_year.cust_type,table_1d.cust_type)` | `cust_type` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:296` |
| `cust_type_desc` | `null` | — | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | rename | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:291` |
| `division` | `division` | `division` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | passthrough | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:28` |
| `division_desc` | `null` | — | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | rename | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:291` |
| `terr_sub_group` | `terr_sub_group` | `terr_sub_group` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | passthrough | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:29` |
| `sub_group_desc` | `null` | — | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | rename | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:291` |
| `terr_group` | `terr_group` | `terr_group` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | passthrough | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:30` |
| `terr_group_desc` | `null` | — | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | rename | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:291` |
| `sales_rep_id` | `sales_rep_id` | `sales_rep_id` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | passthrough | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:31` |
| `sales_sup_id` | `sales_sup_id` | `sales_sup_id` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | passthrough | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:32` |
| `sales_mgr_id` | `sales_mgr_id` | `sales_mgr_id` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | passthrough | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:33` |
| `sales_dir_id` | `sales_dir_id` | `sales_dir_id` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | passthrough | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:34` |
| `sales_vp_id` | `sales_vp_id` | `sales_vp_id` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | passthrough | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:35` |
| `sku_no` | `coalesce(table_dt_month.sku_no, table_last_dt_month.sku_no, table_dt_month_last_year.sku_no,table_1d.sku_no)` | `sku_no` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:309` |
| `part_no` | `null` | — | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | rename | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:291` |
| `mfg_partno` | `null` | — | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | rename | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:291` |
| `vpl_no` | `coalesce(table_dt_month.vpl_no, table_last_dt_month.vpl_no, table_dt_month_last_year.vpl_no,table_1d.vpl_no)` | `vpl_no` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:312` |
| `vpl_code` | `null` | — | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | rename | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:291` |
| `vpc_group_id` | `vpc_group_id` | `vpc_group_id` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | passthrough | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:38` |
| `vpc_group_desc` | `null` | — | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | rename | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:291` |
| `vend_no` | `coalesce(table_dt_month.vend_no, table_last_dt_month.vend_no, table_dt_month_last_year.vend_no,table_1d.vend_no)` | `vend_no` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:316` |
| `vend_name` | `null` | — | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | rename | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:291` |
| `master_vend_no` | `master_vend_no` | `master_vend_no` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | passthrough | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:40` |
| `master_vend_name` | `null` | — | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | rename | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:291` |
| `group_id` | `group_id` | `group_id` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | passthrough | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:38` |
| `seg_code` | `coalesce(table_dt_month.seg_code, table_last_dt_month.seg_code, table_dt_month_last_year.seg_code,table_1d.seg_code)` | `seg_code` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:321` |
| `pm_id` | `pm_id` | `pm_id` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | passthrough | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:43` |
| `pm_mgr_id` | `pm_mgr_id` | `pm_mgr_id` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | passthrough | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:44` |
| `pm_dir_id` | `pm_dir_id` | `pm_dir_id` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | passthrough | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:45` |
| `pm_vp_id` | `pm_vp_id` | `pm_vp_id` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | passthrough | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:46` |
| `buyer_id` | `buyer_id` | `buyer_id` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | passthrough | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:47` |
| `buyer_mgr_id` | `buyer_mgr_id` | `buyer_mgr_id` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | passthrough | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:48` |
| `buyer_dir_id` | `buyer_dir_id` | `buyer_dir_id` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | passthrough | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:49` |
| `buyer_vp_id` | `buyer_vp_id` | `buyer_vp_id` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | passthrough | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:50` |
| `company_no` | `coalesce(table_dt_month.company_no, table_last_dt_month.company_no, table_dt_month_last_year.company_no,table_1d.comp...` | `company_no` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:330` |
| `d_sales` | `sum(case when date_flag = '${date_flag}' then net_sales else 0 end)` | `date_flag`, `net_sales` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | case | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:250` |
| `d_cost` | `sum(case when date_flag = '${date_flag}' then net_cost else 0 end)` | `date_flag`, `net_cost` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | case | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:250` |
| `d_unit` | `sum(case when date_flag = '${date_flag}' then total_unit else 0 end)` | `date_flag`, `total_unit` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | case | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:250` |
| `d_gm` | `sum(case when date_flag = '${date_flag}' then gm_amt else 0 end)` | `date_flag`, `gm_amt` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | case | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:250` |
| `d_ngm` | `sum(case when date_flag = '${date_flag}' then ngm_amt else 0 end)` | `date_flag`, `ngm_amt` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | case | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:250` |
| `d_opl` | `sum(case when date_flag = '${date_flag}' then oplgm_amt else 0 end)` | `date_flag`, `oplgm_amt` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | case | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:250` |
| `d_scm_usage` | `sum(case when date_flag = '${date_flag}' then scm_usage else 0 end)` | `date_flag`, `scm_usage` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | case | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:250` |
| `d_tgm` | `sum(case when date_flag = '${date_flag}' then tgm_amt else 0 end)` | `date_flag`, `tgm_amt` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | case | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:250` |
| `d_cgp` | `sum(case when date_flag = '${date_flag}' then cgp else 0 end)` | `date_flag`, `cgp` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | case | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:250` |
| `d_total_btl` | `sum(case when date_flag = '${date_flag}' then total_btl else 0 end)` | `date_flag`, `total_btl` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | case | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:250` |
| `w_sales` | `sum(net_sales)` | `net_sales` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | agg | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:208` |
| `w_cost` | `sum(net_cost)` | `net_cost` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | agg | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:209` |
| `w_unit` | `sum(total_unit)` | `total_unit` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | agg | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:210` |
| `w_gm` | `sum(gm_amt)` | `gm_amt` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | agg | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:211` |
| `w_ngm` | `sum(ngm_amt)` | `ngm_amt` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | agg | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:212` |
| `w_opl` | `sum(oplgm_amt)` | `oplgm_amt` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | agg | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:213` |
| `w_scm_usage` | `sum(scm_usage)` | `scm_usage` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | agg | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:215` |
| `w_tgm` | `sum(tgm_amt)` | `tgm_amt` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | agg | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:216` |
| `w_cgp` | `sum(cgp)` | `cgp` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | agg | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:225` |
| `w_total_btl` | `sum(total_btl)` | `total_btl` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | agg | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:226` |
| `m_sales` | `sum(net_sales )` | `net_sales` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | agg | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:52` |
| `m_cost` | `sum(net_cost )` | `net_cost` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | agg | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:53` |
| `m_unit` | `sum(total_unit )` | `total_unit` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | agg | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:54` |
| `m_gm` | `sum(gm_amt )` | `gm_amt` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | agg | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:55` |
| `m_ngm` | `sum(ngm_amt )` | `ngm_amt` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | agg | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:56` |
| `m_opl` | `sum(oplgm_amt )` | `oplgm_amt` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | agg | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:57` |
| `m_scm_usage` | `sum(scm_usage )` | `scm_usage` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | agg | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:59` |
| `m_tgm` | `sum(tgm_amt )` | `tgm_amt` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | agg | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:60` |
| `m_scm_disc` | `sum(scm_disc )` | `scm_disc` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | agg | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:61` |
| `m_scm_ndisc` | `sum(scm_ndisc )` | `scm_ndisc` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | agg | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:62` |
| `m_ds_sales` | `sum(ds_sales )` | `ds_sales` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | agg | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:63` |
| `m_stock_sales` | `sum(stock_sales )` | `stock_sales` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | agg | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:64` |
| `m_ds_cost` | `sum(ds_cost )` | `ds_cost` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | agg | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:65` |
| `m_stock_cost` | `sum(stock_cost )` | `stock_cost` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | agg | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:66` |
| `m_ds_scm_usage` | `sum(ds_scm_usage )` | `ds_scm_usage` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | agg | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:67` |
| `m_stock_scm_usage` | `sum(stock_scm_usage )` | `stock_scm_usage` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | agg | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:68` |
| `m_cgp` | `sum(cgp )` | `cgp` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | agg | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:69` |
| `m_total_btl` | `sum(total_btl )` | `total_btl` | `table_dt_month`, `table_last_dt_month`, `table_dt_month_last_year`, `table_1d`, `ods_${country}.ods_cis_corp_parameters`, `ods_${country}.ods_etl_cust_xref_all_df`, `dw_${country}.dws_disty_brpt_pl_extend_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `ods_${country}.ods_cis_corp_cust_type` | agg | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:70` |

_Showing 80 of 175 columns; full list in L3 `*_column_derivations.json` sidecar._
...
|------|--------|-----------------------------------------------------|
| 1 | `conf.get('date_flag')` | Business process date (comment: yesterday / @process_date) — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:11` |
| 3 | `conf.get('dt_month')` | Hive partition key `dt_month` (yyyy-MM derived from date_flag) — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:12` |
...
|------|-------------|----------------|-----------|----------|--------------|
| **Query for reporting** | `dw_us.dws_disty_brpt_pl_extend_comb_mtd` | `dw_us.dws_disty_brpt_pl_extend_comb_mtd` | overwrite / incremental | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py` | yes |
| **Hive alternative** | `dw_us.dws_disty_brpt_pl_extend_comb_mtd` | same as reporting table | — | ETL target table | — |
| **ETL internal** | `dw_us.dws_disty_brpt_pl_extend_comb_mtd` | n/a | INSERT OVERWRITE | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py` | — |
...
|--------|-------|----------|
| `dim_us.dim_pub_customer_info_df` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py` |
| `dim_us.dim_pub_part_info_df` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py` |
| `dim_us.dim_pub_sales_mgr_dept_df` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py` |
| `dim_us.dim_pub_sales_rep_terr_df` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py` |
| `dim_us.dim_pub_sales_territory_df` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py` |
| `dim_us.dim_pub_vendor_info_df` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py` |
| `dim_us.dim_pub_vpl_hierarchy_info_df` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py` |
| `dim_us.dim_pub_vpl_info_df` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py` |
| `dw_us.dws_disty_brpt_pl_extend_1d` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py` |
| `dw_us.dws_disty_brpt_pl_extend_mtd` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py` |
| `ods_us.ods_breport_mydaas_breport_parameter` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py` |
| `ods_us.ods_cis_corp_cust_type` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py` |
| `ods_us.ods_cis_corp_division` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py` |
| `ods_us.ods_cis_corp_parameters` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py` |
| `ods_us.ods_cis_corp_territory_group` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py` |

#### Downstream consumers (verified)
| Object / script | Evidence |
|-----------------|----------|
| B Report dashboards / sibling DM tables | `source/contracts/b-report-us/tables/dws_disty_brpt_pl_extend_comb_mtd.md:L6` |

#### Operational detail (verified)
- Load pattern: INSERT OVERWRITE (partitioned) per ETL SQL — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py:287`
- ETL script path: `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py`
...
- `dws_disty_brpt_pl_extend_comb_mtd.py` — primary Bitbucket ETL for `dws_disty_brpt_pl_extend_comb_mtd` — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py`

---

*Document generated from `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_pl_extend_comb_mtd/Common/python/dws_disty_brpt_pl_extend_comb_mtd.py` with B Report contract enrichment when available.*
