...
**Domain:** b-report-us  
**Source contract:** `source/contracts/b-report-us/tables/dm_disty_brpt_pm_wtd.md`  
**Knowledgebase path:** `target/knowledgebase/b-report-us/dm_disty_brpt_pm_wtd.md`
...
|-------|------------------|
| **Catalog object** | `dm_us.dm_disty_brpt_pm_wtd` — DM layer table used in US B Report analytics (`US B Report baseline`). |
...
|------|-------------|----------------|-----------|----------|--------------|
| **Query for reporting** | `dm_us.dm_disty_brpt_pm_wtd` | `dm_us.dm_disty_brpt_pm_wtd` | overwrite / incremental | B Report contract `dm_disty_brpt_pm_wtd.md:L1` | yes (B Report contract v2 — Vertica verified in source catalog) |
| **Hive alternative** | `dm_us.dm_disty_brpt_pm_wtd` | same as reporting table | - | B Report contract cross-engine note | - |
| **ETL internal** | n/a | n/a | - | ETL not in wiki repo | - |

Business users should query **`dm_us.dm_disty_brpt_pm_wtd`** in Vertica for B Report reporting aligned to this contract.
...
**Target table:** `dm_us.dm_disty_brpt_pm_wtd`  
...
flowchart LR
  ...
  tgt["dm_us.dm_disty_brpt_pm_wtd"]
...
|--------|-----------------|
| `dm_us.dm_disty_brpt_pm_wtd` | Primary catalog table documented from B Report contract |
...
|--------|-------|----------|
| B Report contract source | Table metadata, grain, columns | `source/contracts/b-report-us/tables/dm_disty_brpt_pm_wtd.md` |

### Downstream consumers (verified)

| Object / script | Evidence |
|-----------------|----------|
| B Report consumers | `dm_disty_brpt_pm_wtd.md:L6` — see contract L6 |
...
*Document generated from B Report contract `source/contracts/b-report-us/tables/dm_disty_brpt_pm_wtd.md`.*
