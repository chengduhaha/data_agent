...
- artifact_id: rds.starrocks_vpo.vpo_inventory_open_po_eta_rio_runrate_rds_7806
- domain: RDS/starrocks_vpo
- one_line_purpose: RDS vpo report SQL on StarRocks producing `tempdb.rds_tmp`
- layer_type: REPORT
- source_kind: rds_report_sql
- evidence_source: source/contracts/rds/starrocks_vpo/etl/vpo_inventory_open_po_eta_rio_runrate_rds_7806.sql
- knowledgebase_path: target/knowledgebase/RDS/starrocks_vpo/vpo_inventory_open_po_eta_rio_runrate_rds_7806.md
...
| **ddl_source** | Report SQL — `source/contracts/rds/starrocks_vpo/etl/vpo_inventory_open_po_eta_rio_runrate_rds_7806.sql` |
| **retrieval** | `python -m tools.wkb.indexing.run_query --query "RDS starrocks_vpo vpo_inventory_open_po_eta_rio_runrate_rds_7806" --intent find_table_schema` |

### Lineage
- **upstream:** `ods_us.ods_cis_corp_inv_qty_rt` — `source/contracts/rds/starrocks_vpo/etl/vpo_inventory_open_po_eta_rio_runrate_rds_7806.sql`
- **upstream:** `ods_us.ods_cis_corp_vend_master_rt` — `source/contracts/rds/starrocks_vpo/etl/vpo_inventory_open_po_eta_rio_runrate_rds_7806.sql`
- **upstream:** `ods_us.ods_cis_corp_part_master_rt` — `source/contracts/rds/starrocks_vpo/etl/vpo_inventory_open_po_eta_rio_runrate_rds_7806.sql`
- **upstream:** `dw_us.dwd_disty_inv_aging_df` — `source/contracts/rds/starrocks_vpo/etl/vpo_inventory_open_po_eta_rio_runrate_rds_7806.sql`
- **upstream:** `ods_us.ods_cis_corp_order_header_rt` — `source/contracts/rds/starrocks_vpo/etl/vpo_inventory_open_po_eta_rio_runrate_rds_7806.sql`
- **upstream:** `ods_us.ods_cis_corp_order_eta_detail_rt` — `source/contracts/rds/starrocks_vpo/etl/vpo_inventory_open_po_eta_rio_runrate_rds_7806.sql`
- **upstream:** `ods_us.ods_cis_corp_order_detail_rt` — `source/contracts/rds/starrocks_vpo/etl/vpo_inventory_open_po_eta_rio_runrate_rds_7806.sql`
- **upstream:** `ods_us.ods_cis_corp_rio_request_header_rt` — `source/contracts/rds/starrocks_vpo/etl/vpo_inventory_open_po_eta_rio_runrate_rds_7806.sql`
- **upstream:** `ods_us.ods_cis_corp_rio_req_detail_rt` — `source/contracts/rds/starrocks_vpo/etl/vpo_inventory_open_po_eta_rio_runrate_rds_7806.sql`
- **upstream:** `dw_us.dws_disty_pur_ips_runrate_1w` — `source/contracts/rds/starrocks_vpo/etl/vpo_inventory_open_po_eta_rio_runrate_rds_7806.sql`
- **downstream:** `tempdb.rds_tmp` (report output) — `source/contracts/rds/starrocks_vpo/etl/vpo_inventory_open_po_eta_rio_runrate_rds_7806.sql`
- **downstream:** `tempdb.rds_tmp_body` (report output) — `source/contracts/rds/starrocks_vpo/etl/vpo_inventory_open_po_eta_rio_runrate_rds_7806.sql`
...
|---------------|-----------|---------|----------|
| See SQL JOIN list | Not documented in repository | Dimension enrichment in report | `source/contracts/rds/starrocks_vpo/etl/vpo_inventory_open_po_eta_rio_runrate_rds_7806.sql` |
...
```sql
-- Use date predicates from source/contracts/rds/starrocks_vpo/etl/vpo_inventory_open_po_eta_rio_runrate_rds_7806.sql; do not invent partition values.
```
...
|------|--------|----------------------------------|
| 1 | Report SQL | Session/current_date or explicit literals in `source/contracts/rds/starrocks_vpo/etl/vpo_inventory_open_po_eta_rio_runrate_rds_7806.sql` — Not documented as Azkaban partition |
...
|------|-------------|----------------|-----------|----------|--------------|
| Report output | N/A | `tempdb.rds_tmp` (StarRocks) | on-demand | `source/contracts/rds/starrocks_vpo/etl/vpo_inventory_open_po_eta_rio_runrate_rds_7806.sql` | no |
...
```sql
-- See full script: source/contracts/rds/starrocks_vpo/etl/vpo_inventory_open_po_eta_rio_runrate_rds_7806.sql
```
...
|--------|-------|----------|
| `ods_us.ods_cis_corp_inv_qty_rt` | FROM/JOIN source | `source/contracts/rds/starrocks_vpo/etl/vpo_inventory_open_po_eta_rio_runrate_rds_7806.sql` |
| `ods_us.ods_cis_corp_vend_master_rt` | FROM/JOIN source | `source/contracts/rds/starrocks_vpo/etl/vpo_inventory_open_po_eta_rio_runrate_rds_7806.sql` |
| `ods_us.ods_cis_corp_part_master_rt` | FROM/JOIN source | `source/contracts/rds/starrocks_vpo/etl/vpo_inventory_open_po_eta_rio_runrate_rds_7806.sql` |
| `dw_us.dwd_disty_inv_aging_df` | FROM/JOIN source | `source/contracts/rds/starrocks_vpo/etl/vpo_inventory_open_po_eta_rio_runrate_rds_7806.sql` |
| `ods_us.ods_cis_corp_order_header_rt` | FROM/JOIN source | `source/contracts/rds/starrocks_vpo/etl/vpo_inventory_open_po_eta_rio_runrate_rds_7806.sql` |
| `ods_us.ods_cis_corp_order_eta_detail_rt` | FROM/JOIN source | `source/contracts/rds/starrocks_vpo/etl/vpo_inventory_open_po_eta_rio_runrate_rds_7806.sql` |
| `ods_us.ods_cis_corp_order_detail_rt` | FROM/JOIN source | `source/contracts/rds/starrocks_vpo/etl/vpo_inventory_open_po_eta_rio_runrate_rds_7806.sql` |
| `ods_us.ods_cis_corp_rio_request_header_rt` | FROM/JOIN source | `source/contracts/rds/starrocks_vpo/etl/vpo_inventory_open_po_eta_rio_runrate_rds_7806.sql` |
| `ods_us.ods_cis_corp_rio_req_detail_rt` | FROM/JOIN source | `source/contracts/rds/starrocks_vpo/etl/vpo_inventory_open_po_eta_rio_runrate_rds_7806.sql` |
| `dw_us.dws_disty_pur_ips_runrate_1w` | FROM/JOIN source | `source/contracts/rds/starrocks_vpo/etl/vpo_inventory_open_po_eta_rio_runrate_rds_7806.sql` |

#### Downstream consumers (verified)
| Object / script | Evidence |
|-----------------|----------|
| `tempdb.rds_tmp` final report result | `source/contracts/rds/starrocks_vpo/etl/vpo_inventory_open_po_eta_rio_runrate_rds_7806.sql` |
...
*Document generated from `source/contracts/rds/starrocks_vpo/etl/vpo_inventory_open_po_eta_rio_runrate_rds_7806.sql` (source_kind: rds_report_sql).*
