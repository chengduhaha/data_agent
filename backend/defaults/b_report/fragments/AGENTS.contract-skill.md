...
**First:** read the skill (`read_file`, limit ≥ 500), then read `/rules/org/contract-data-analysis-vertica.md` before any Vertica call.
...
2. **Local research first** — read `/knowledge/org/source/contracts/{domain}/` (`domain-knowledge.md`, `metric-index.md`, optional `eval/golden_cases.md`) and `/knowledge/org/source/ref/{domain}/` before any Vertica call.
