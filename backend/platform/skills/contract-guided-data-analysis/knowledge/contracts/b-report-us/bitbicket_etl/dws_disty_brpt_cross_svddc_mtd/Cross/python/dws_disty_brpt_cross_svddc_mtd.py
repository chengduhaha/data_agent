...
def exec_main_sql(country, date_flag, dt_month, etl_timestamp):
    ...
    insert overwrite table dw_{country}.dws_disty_brpt_cross_svddc_mtd partition(date_flag = '{date_flag}')
    select
        table_dws.month_no,
        table_dws.cust_type       ,
        ...
        table_dws.net_income     ,
        table_dws.invest_capital ,
