...
# dw_${country}.dws_disty_brpt_cust_type_1d
...
def exec_sql():
    run_sql("""
    insert overwrite table dw_${country}.dws_disty_brpt_division_1d partition(date_flag)
    select
        division     ,
        division_desc,
        company_no   ,
        ...
        date_flag
    from dw_${country}.dws_disty_brpt_cust_type_1d
