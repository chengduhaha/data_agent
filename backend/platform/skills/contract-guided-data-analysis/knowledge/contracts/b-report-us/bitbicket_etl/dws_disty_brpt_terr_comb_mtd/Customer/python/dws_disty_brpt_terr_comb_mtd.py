...
def exec_main_sql(country, date_flag, dt_month, etl_timestamp):
    ...
    insert overwrite table dw_${country}.dws_disty_brpt_terr_comb_mtd partition(date_flag = '${date_flag}')
    select 
        ${month_no},
        ...
        coalesce(table_dws.sales_dir_id   ,table4.manager_id,  -3)          as sales_dir_id,
        coalesce(table_dws.sales_vp_id    ,table5.manager_id,  -3)          as sales_vp_id,
