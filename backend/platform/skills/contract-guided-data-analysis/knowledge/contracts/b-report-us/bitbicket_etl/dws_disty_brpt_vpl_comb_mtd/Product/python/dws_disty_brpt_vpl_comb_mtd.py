...
def main():
    ...
    from dw_{country}.dws_disty_brpt_vpl_1d
    ...
    insert overwrite table dw_{country}.dws_disty_brpt_vpl_comb_mtd partition(date_flag = '{date_flag}')
    select
        {month_no},
        ...
        table_dt_month.reg_inv,
        table_dt_month.reg_inv_age0_30,
        table_dt_month.reg_inv_age31_60,
        table_dt_month.reg_inv_age61_90,
        table_dt_month.reg_inv_age90_up,
        table_dt_month.rma_inv,
        table_dt_month.rma_inv_age0_30,
        table_dt_month.rma_inv_age31_60,
        table_dt_month.rma_inv_age61_90,
        table_dt_month.rma_inv_age90_up,
        table_dt_month.oh_cost,
        table_dt_month.oo_cost,
        table_dt_month.oh_qty,
        table_dt_month.oo_qty,
    ...
    on table_dt_month.vpl_no = table_last_dt_month.vpl_no
    ...
    on  nvl(table_dt_month.vpl_no    ,table_last_dt_month.vpl_no    ) = table_dt_month_last_year.vpl_no
    ...
    full join table_1d
    on  coalesce(table_dt_month.vpl_no    ,table_last_dt_month.vpl_no    ,table_dt_month_last_year.vpl_no    ) = table_1d.vpl_no
    ...
    select 
        table_dwd.month_no,
        coalesce(table_dwd.vpl_no,-3)                              as vpl_no,
        table_vpl.vpl_code,
        ...
        coalesce(table_dwd.vend_no,-3)                             as vend_no,
        table_vend.vend_name,
        coalesce(table_vend.master_vend_no,-3)                     as master_vend_no,
