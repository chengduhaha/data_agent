...
def main():
    ...
    run_sql("""
    insert overwrite table dm_${country}.dm_disty_brpt_sales_wtd partition(dt_week)
    select
        ...
        table_dim.week_flag
    from (select * from dm_${country}.dm_disty_brpt_sales_1d
