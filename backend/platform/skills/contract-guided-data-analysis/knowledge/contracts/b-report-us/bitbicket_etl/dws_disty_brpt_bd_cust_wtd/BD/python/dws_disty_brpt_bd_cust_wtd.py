...
def main():
    ...
    run_sql("""
    insert overwrite table dw_${country}.dws_disty_brpt_bd_cust_wtd partition(dt_week)
    select
        ...
        table_dim.week_flag
    from (select * from dw_${country}.dws_disty_brpt_bd_cust_1d
