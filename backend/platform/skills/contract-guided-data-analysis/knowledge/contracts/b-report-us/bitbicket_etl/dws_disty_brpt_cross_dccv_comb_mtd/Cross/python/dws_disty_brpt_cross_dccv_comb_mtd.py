...
def exec_main_sql(country, date_flag, dt_month, etl_timestamp):
    ...
    main_sql = r"""
    insert overwrite table dw_{country}.dws_disty_brpt_cross_dccv_comb_mtd partition(date_flag = '{date_flag}')
    select
        {month_no},
        cust_terr           ,
        terr_name           ,
