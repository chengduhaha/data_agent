# -*- coding: utf-8 -*-
# @Time : 10/6/2023 2:41 PM
# @Author : Marvin Ma

from synnex.bigdata import conf
from synnex.bigdata.pyspark import run_sql

# dw_{country}.dws_disty_brpt_cross_mpc_mtd
# dw_{country}.dws_disty_brpt_cross_mpc_1d
...
def exec_main_sql(country, date_flag, dt_month, etl_timestamp):
    ...
    from dw_{country}.dws_disty_brpt_cross_mpc_mtd
    ...
    from dw_{country}.dws_disty_brpt_cross_mpc_1d
    ...
    insert overwrite table dw_{country}.dws_disty_brpt_cross_mpc_comb_mtd partition(date_flag = '{date_flag}')
    select
        {month_no},
        ...
        coalesce(table_dt_month.pm_id, table_last_dt_month.pm_id, table_dt_month_last_year.pm_id,table_1d.pm_id) as pm_id,
        null as pm_name	            ,
        coalesce(table_dt_month.pm_mgr_id, table_last_dt_month.pm_mgr_id, table_dt_month_last_year.pm_mgr_id,table_1d.pm_mgr_id) as pm_mgr_id,
        null as pm_manager_name	    ,
    ...
    and table_dt_month.pm_id = table_last_dt_month.pm_id
    and table_dt_month.pm_mgr_id = table_last_dt_month.pm_mgr_id
    ...
    and nvl(table_dt_month.pm_id     ,table_last_dt_month.pm_id     ) = table_dt_month_last_year.pm_id
    and nvl(table_dt_month.pm_mgr_id ,table_last_dt_month.pm_mgr_id ) = table_dt_month_last_year.pm_mgr_id
    ...
    and coalesce(table_dt_month.pm_id     ,table_last_dt_month.pm_id     ,table_dt_month_last_year.pm_id     ) = table_1d.pm_id
    and coalesce(table_dt_month.pm_mgr_id ,table_last_dt_month.pm_mgr_id ,table_dt_month_last_year.pm_mgr_id ) = table_1d.pm_mgr_id
    ...
    coalesce(table_dwd.cust_terr,-3)                                                     as cust_terr, 
    ...
    table_cust_terr.terr_sub_group_desc                                     as sub_group_desc,
    ...
    coalesce(table_dwd.cust_type,-3)                                                     as cust_type,
    ...
    concat_ws(' ', table_manager.firstname, table_manager.lastname),
    nvl(table_dwd.pm_mgr_id,-3),
    concat_ws(' ', table_manager2.firstname, table_manager2.lastname),
    nvl(table_dwd.pm_dir_id,-3),
    concat_ws(' ', table_manager3.firstname, table_manager3.lastname),
    nvl(table_dwd.pm_vp_id,-3),
    concat_ws(' ', table_manager4.firstname, table_manager4.lastname),
    ...
    from (select *
          from dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd
    ...
    on table_dwd.pm_id = table_manager.userid
    left join ods_${country}.ods_cis_corp_manager as table_manager2   --unique id : userid
    on table_dwd.pm_mgr_id = table_manager2.userid
