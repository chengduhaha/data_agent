# DWS: B Report combined-month profitability serving slice (cross_mpc_comb_mtd) (`dw_us.dws_disty_brpt_cross_mpc_comb_mtd`)
...
- layer_type: DWS
- source_kind: etl_sql
- evidence_source: source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py
- knowledgebase_path: target/knowledgebase/b-report-us/dws_disty_brpt_cross_mpc_comb_mtd.md
- contract_source: source/contracts/b-report-us/tables/dws_disty_brpt_cross_mpc_comb_mtd.md
...
|--------|---------|---------------|-------|
| Hive | yes | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd` | ETL target in Bitbucket script |
| Vertica | yes | `dw_us.dws_disty_brpt_cross_mpc_comb_mtd` | Contract marks Vertica verified |

### Physical schema reference
| Field | Value |
|-------|-------|
| **Authoritative catalog** | WKB L1 storage seed (not duplicated in this file) |
| **entity_id** | `dw_us.dws_disty_brpt_cross_mpc_comb_mtd` |
| **l1_catalog_seed** | `target/storage/wkb/snapshots/_snapshot_id_template/l1_catalog/vertica_dw_us_dws_disty_brpt_cross_mpc_comb_mtd.json` |
| **column_count** | 156 |
| **partition_keys** | `month_no` |
| **ddl_source** | B Report contract catalog and/or VERTICA/vcdisty DDL |
| **retrieval** | `python -m tools.wkb.indexing.run_query --query "b-report-us dws_disty_brpt_cross_mpc_comb_mtd schema" --intent find_table_schema` |

### Lineage
- **upstream:** dim_us.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df, dim_us.dim_pub_customer_info_df, ods_us.ods_breport_mydaas_breport_parameter, ods_us.ods_cis_corp_cust_type, ods_us.ods_cis_corp_division, ods_us.ods_cis_corp_manager — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py`
- **downstream:** B Report DM/DWS serving and dashboards (per contract L6 when present) — `source/contracts/b-report-us/tables/dws_disty_brpt_cross_mpc_comb_mtd.md`
...
### Business purpose
B Report combined-month profitability serving slice (cross_mpc_comb_mtd)
...
|---------------|-----------|---------|----------|
| (ETL join) | — | left join (select * from temp_cust_xref_company | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py` |
...
### End-to-end flow
1. Read upstream warehouse objects (dim_us.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df, dim_us.dim_pub_customer_info_df, ods_us.ods_breport_mydaas_breport_parameter, ods_us.ods_cis_corp_cust_type).
2. Apply CTE aggregations and business joins inside ETL SQL.
3. INSERT OVERWRITE into `dw_us.dws_disty_brpt_cross_mpc_comb_mtd` partition `month_no`.
4. Sync to Vertica for B Report consumption (sync job not verified in this repository unless cited below).

```mermaid
flowchart LR
  dw_us_dws_disty_brpt_cross_mpc_comb_mtd["dw_us.dws_disty_brpt_cross_mpc_comb_mtd"]
  src0["dim_us.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df"]
  src0 --> dw_us_dws_disty_brpt_cross_mpc_comb_mtd
  src1["dim_us.dim_pub_customer_info_df"]
  src1 --> dw_us_dws_disty_brpt_cross_mpc_comb_mtd
  src2["ods_us.ods_breport_mydaas_breport_parameter"]
  src2 --> dw_us_dws_disty_brpt_cross_mpc_comb_mtd
  src3["ods_us.ods_cis_corp_cust_type"]
  src3 --> dw_us_dws_disty_brpt_cross_mpc_comb_mtd
  src4["ods_us.ods_cis_corp_division"]
  src4 --> dw_us_dws_disty_brpt_cross_mpc_comb_mtd
  src5["ods_us.ods_cis_corp_manager"]
  src5 --> dw_us_dws_disty_brpt_cross_mpc_comb_mtd
  src6["ods_us.ods_cis_corp_parameters"]
  src6 --> dw_us_dws_disty_brpt_cross_mpc_comb_mtd
  src7["ods_us.ods_etl_cust_xref_all_df"]
  src7 --> dw_us_dws_disty_brpt_cross_mpc_comb_mtd
  consumers["B Report dashboards / DM serving"]
  dw_us_dws_disty_brpt_cross_mpc_comb_mtd --> consumers
```
...
| `dw_us.dws_disty_brpt_cross_mpc_comb_mtd` | target |
...
|---------------|----------------|------------------|-----------------|----------------|----------|
| `month_no` | `table_dwd.month_no` | `month_no` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | passthrough | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:505` |
| `3` | `coalesce(table_dwd.cust_no,-3)` | `cust_no` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:507` |
| `cust_name_replace` | `table_customer.cust_name_replace` | `cust_name_replace` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | passthrough | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:508` |
| `mcust_no` | `coalesce(table_dwd.mcust_no,cxc.cust_no, dbp.icode1, cx.xref_no, table_customer.mcust_no,-3)` | `mcust_no`, `cust_no`, `icode1`, `xref_no` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:509` |
| `mcust_name` | `table_mcustomer.cust_name_replace` | `cust_name_replace` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | rename | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:510` |
| `cust_terr` | `coalesce(table_dwd.cust_terr,-3)` | `cust_terr` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:511` |
| `terr_name` | `table_cust_terr.terr_name` | `terr_name` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | passthrough | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:512` |
| `terr_sub_group` | `coalesce(table_dwd.terr_sub_group,table_cust_terr.terr_sub_group,-3)` | `terr_sub_group` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:513` |
| `sub_group_desc` | `table_cust_terr.terr_sub_group_desc` | `terr_sub_group_desc` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | rename | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:514` |
| `terr_group` | `coalesce(table_dwd.terr_group,table_cust_terr.terr_group,-3)` | `terr_group` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:515` |
| `terr_group_desc` | `table_cust_terr.terr_group_desc` | `terr_group_desc` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | passthrough | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:516` |
| `cust_type` | `coalesce(table_dwd.cust_type,-3)` | `cust_type` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:517` |
| `cust_type_desc` | `table_cust_type.cust_type_descr` | `cust_type_descr` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | rename | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:518` |
| `division` | `coalesce(table_dwd.division,table_cust_type.division,-3)` | `division` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:519` |
| `division_desc` | `table_div.division_desc` | `division_desc` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | passthrough | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:520` |
| `3` | `nvl(table_dwd.pm_id,-3)` | `pm_id` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:522` |
| `lastname` | `concat_ws(' ', table_manager.firstname, table_manager.lastname)` | `concat_ws`, `firstname`, `lastname` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | udf | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:523` |
| `3` | `nvl(table_dwd.pm_mgr_id,-3)` | `pm_mgr_id` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:524` |
| `lastname` | `concat_ws(' ', table_manager2.firstname, table_manager2.lastname)` | `concat_ws`, `firstname`, `lastname` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | udf | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:525` |
| `3` | `nvl(table_dwd.pm_dir_id,-3)` | `pm_dir_id` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:526` |
| `lastname` | `concat_ws(' ', table_manager3.firstname, table_manager3.lastname)` | `concat_ws`, `firstname`, `lastname` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | udf | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:527` |
| `3` | `nvl(table_dwd.pm_vp_id,-3)` | `pm_vp_id` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:528` |
| `lastname` | `concat_ws(' ', table_manager4.firstname, table_manager4.lastname)` | `concat_ws`, `firstname`, `lastname` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | udf | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:529` |
| `company_no` | `table_dwd.company_no` | `company_no` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | passthrough | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:530` |
| `0` | `nvl(table_dwd.d_sales,0)` | `d_sales` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:532` |
| `0` | `nvl(table_dwd.d_cost,0)` | `d_cost` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:533` |
| `0` | `nvl(table_dwd.d_unit,0)` | `d_unit` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:534` |
| `0` | `nvl(table_dwd.d_gm,0)` | `d_gm` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:535` |
| `0` | `nvl(table_dwd.d_ngm,0)` | `d_ngm` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:536` |
| `0` | `nvl(table_dwd.d_opl,0)` | `d_opl` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:537` |
| `0` | `nvl(table_dwd.d_scm_usage,0)` | `d_scm_usage` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:538` |
| `0` | `nvl(table_dwd.d_tgm,0)` | `d_tgm` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:539` |
| `0` | `nvl(table_dwd.d_cgp,0)` | `d_cgp` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:540` |
| `0` | `nvl(table_dwd.d_total_btl,0)` | `d_total_btl` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:541` |
| `0` | `nvl(table_dwd.w_sales,0)` | `w_sales` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:542` |
| `0` | `nvl(table_dwd.w_cost,0)` | `w_cost` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:543` |
| `0` | `nvl(table_dwd.w_unit,0)` | `w_unit` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:544` |
| `0` | `nvl(table_dwd.w_gm,0)` | `w_gm` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:545` |
| `0` | `nvl(table_dwd.w_ngm,0)` | `w_ngm` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:546` |
| `0` | `nvl(table_dwd.w_opl,0)` | `w_opl` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:547` |
| `0` | `nvl(table_dwd.w_scm_usage,0)` | `w_scm_usage` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:548` |
| `0` | `nvl(table_dwd.w_tgm,0)` | `w_tgm` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:549` |
| `0` | `nvl(table_dwd.w_cgp,0)` | `w_cgp` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:550` |
| `0` | `nvl(table_dwd.w_total_btl,0)` | `w_total_btl` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:551` |
| `0` | `nvl(table_dwd.m_sales,0)` | `m_sales` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:552` |
| `0` | `nvl(table_dwd.m_cost,0)` | `m_cost` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:553` |
| `0` | `nvl(table_dwd.m_unit,0)` | `m_unit` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:554` |
| `0` | `nvl(table_dwd.m_gm,0)` | `m_gm` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:555` |
| `0` | `nvl(table_dwd.m_ngm,0)` | `m_ngm` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:556` |
| `0` | `nvl(table_dwd.m_opl,0)` | `m_opl` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:557` |
| `0` | `nvl(table_dwd.m_scm_usage,0)` | `m_scm_usage` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:558` |
| `0` | `nvl(table_dwd.m_tgm,0)` | `m_tgm` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:559` |
| `0` | `nvl(table_dwd.m_scm_disc,0)` | `m_scm_disc` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:560` |
| `0` | `nvl(table_dwd.m_scm_ndisc,0)` | `m_scm_ndisc` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:561` |
| `0` | `nvl(table_dwd.m_ds_sales,0)` | `m_ds_sales` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:562` |
| `0` | `nvl(table_dwd.m_stock_sales,0)` | `m_stock_sales` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:563` |
| `0` | `nvl(table_dwd.m_ds_cost,0)` | `m_ds_cost` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:564` |
| `0` | `nvl(table_dwd.m_stock_cost,0)` | `m_stock_cost` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:565` |
| `0` | `nvl(table_dwd.m_ds_scm_usage,0)` | `m_ds_scm_usage` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:566` |
| `0` | `nvl(table_dwd.m_stock_scm_usage,0)` | `m_stock_scm_usage` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:567` |
| `0` | `nvl(table_dwd.m_cgp,0)` | `m_cgp` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:568` |
| `0` | `nvl(table_dwd.m_total_btl,0)` | `m_total_btl` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:569` |
| `0` | `nvl(table_dwd.pm_sales,0)` | `pm_sales` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:570` |
| `0` | `nvl(table_dwd.pm_cost,0)` | `pm_cost` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:571` |
| `0` | `nvl(table_dwd.pm_unit,0)` | `pm_unit` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:572` |
| `0` | `nvl(table_dwd.pm_gm,0)` | `pm_gm` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:573` |
| `0` | `nvl(table_dwd.pm_ngm,0)` | `pm_ngm` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:574` |
| `0` | `nvl(table_dwd.pm_opl,0)` | `pm_opl` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:575` |
| `0` | `nvl(table_dwd.pm_scm_usage,0)` | `pm_scm_usage` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:576` |
| `0` | `nvl(table_dwd.pm_tgm,0)` | `pm_tgm` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:577` |
| `0` | `nvl(table_dwd.pm_scm_disc,0)` | `pm_scm_disc` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:578` |
| `0` | `nvl(table_dwd.pm_scm_ndisc,0)` | `pm_scm_ndisc` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:579` |
| `0` | `nvl(table_dwd.pm_ds_sales,0)` | `pm_ds_sales` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:580` |
| `0` | `nvl(table_dwd.pm_stock_sales,0)` | `pm_stock_sales` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:581` |
| `0` | `nvl(table_dwd.pm_ds_cost,0)` | `pm_ds_cost` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:582` |
| `0` | `nvl(table_dwd.pm_stock_cost,0)` | `pm_stock_cost` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:583` |
| `0` | `nvl(table_dwd.pm_ds_scm_usage,0)` | `pm_ds_scm_usage` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:584` |
| `0` | `nvl(table_dwd.pm_stock_scm_usage,0)` | `pm_stock_scm_usage` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:585` |
| `0` | `nvl(table_dwd.pm_cgp,0)` | `pm_cgp` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:586` |
| `0` | `nvl(table_dwd.pm_total_btl,0)` | `pm_total_btl` | `dw_${country}.dws_disty_brpt_cross_mpc_comb_mtd`, `dim_${country}.dim_pub_customer_info_df`, `temp_mcust_no_clean`, `ods_${country}.ods_breport_mydaas_breport_parameter`, `temp_cust_xref_company`, `dim_${country}.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:587` |
...
|------|--------|-----------------------------------------------------|
| 1 | `conf.get('date_flag')` | Business process date (comment: yesterday / @process_date) — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:14` |
| 2 | `conf.get('month_no')` | Fiscal month index used in SELECT/goal joins — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:26` |
| 3 | `conf.get('dt_month')` | Hive partition key `dt_month` (yyyy-MM derived from date_flag) — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:15` |
| — | `conf.get('end_day_of_last_month')` | Period anchor for comb_mtd wide columns — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:22` |
| — | `conf.get('week_begin_of_dateflag')` | Period anchor for comb_mtd wide columns — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:25` |
| — | `conf.get('end_day_of_same_month_of_last_year')` | Period anchor for comb_mtd wide columns — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:24` |
...
|------|-------------|----------------|-----------|----------|--------------|
| **Query for reporting** | `dw_us.dws_disty_brpt_cross_mpc_comb_mtd` | `dw_us.dws_disty_brpt_cross_mpc_comb_mtd` | overwrite / incremental | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py` | yes |
| **Hive alternative** | `dw_us.dws_disty_brpt_cross_mpc_comb_mtd` | same as reporting table | — | ETL target table | — |
| **ETL internal** | `dw_us.dws_disty_brpt_cross_mpc_comb_mtd` | n/a | INSERT OVERWRITE | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py` | — |
...
|--------|-------|----------|
| `dim_us.dim_disty_brpt_sales_hierarchy_primary_role_by_terr_df` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py` |
| `dim_us.dim_pub_customer_info_df` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py` |
| `ods_us.ods_breport_mydaas_breport_parameter` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py` |
| `ods_us.ods_cis_corp_cust_type` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py` |
| `ods_us.ods_cis_corp_division` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py` |
| `ods_us.ods_cis_corp_manager` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py` |
| `ods_us.ods_cis_corp_parameters` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py` |
| `ods_us.ods_etl_cust_xref_all_df` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py` |

#### Downstream consumers (verified)
| Object / script | Evidence |
|-----------------|----------|
| B Report dashboards / sibling DM tables | `source/contracts/b-report-us/tables/dws_disty_brpt_cross_mpc_comb_mtd.md:L6` |

#### Operational detail (verified)
- Load pattern: INSERT OVERWRITE (partitioned) per ETL SQL — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py:260`
- ETL script path: `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py`
...
- `dws_disty_brpt_cross_mpc_comb_mtd.py` — primary Bitbucket ETL for `dws_disty_brpt_cross_mpc_comb_mtd` — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py`

---

*Document generated from `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_mpc_comb_mtd/Cross/python/dws_disty_brpt_cross_mpc_comb_mtd.py` with B Report contract enrichment when available.*
