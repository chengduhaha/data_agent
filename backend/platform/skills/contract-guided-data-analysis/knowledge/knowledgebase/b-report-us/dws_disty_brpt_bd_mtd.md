# DWS: B Report profitability serving aggregation (mtd) by business slice (`dw_us.dws_disty_brpt_bd_mtd`)
...
- layer_type: DWS
- source_kind: etl_sql
- evidence_source: source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_mtd/Common/bd/dws_disty_brpt_bd_mtd_v2.py
- knowledgebase_path: target/knowledgebase/b-report-us/dws_disty_brpt_bd_mtd.md
- contract_source: source/contracts/b-report-us/tables/dws_disty_brpt_bd_mtd.md
...
|--------|---------|---------------|-------|
| Hive | yes | `dw_${country}.dws_disty_brpt_bd_mtd` | ETL target in Bitbucket script |
| Vertica | yes | `dw_us.dws_disty_brpt_bd_mtd` | Contract marks Vertica verified |

### Physical schema reference
| Field | Value |
|-------|-------|
| **Authoritative catalog** | WKB L1 storage seed (not duplicated in this file) |
| **entity_id** | `dw_us.dws_disty_brpt_bd_mtd` |
| **l1_catalog_seed** | `target/storage/wkb/snapshots/_snapshot_id_template/l1_catalog/vertica_dw_us_dws_disty_brpt_bd_mtd.json` |
| **column_count** | 156 |
| **partition_keys** | `month_no` |
| **ddl_source** | B Report contract catalog and/or VERTICA/vcdisty DDL |
| **retrieval** | `python -m tools.wkb.indexing.run_query --query "b-report-us dws_disty_brpt_bd_mtd schema" --intent find_table_schema` |

### Lineage
- **upstream:** 1.1, 1.2, 1.3, 1.4, 1.filter, 2.1 — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_mtd/Common/bd/dws_disty_brpt_bd_mtd_v2.py`
- **downstream:** B Report DM/DWS serving and dashboards (per contract L6 when present) — `source/contracts/b-report-us/tables/dws_disty_brpt_bd_mtd.md`
...
|---------------|-----------|---------|----------|
| (ETL join) | — | inner join (select * from ods_${country}.ods_etl_bd_project_df | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_mtd/Common/bd/dws_disty_brpt_bd_mtd_v2.py` |
| (ETL join) | — | inner join (select * from ods_${country}.ods_etl_bd_project_df | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_mtd/Common/bd/dws_disty_brpt_bd_mtd_v2.py` |
| (ETL join) | — | inner join (select * from ods_${country}.ods_etl_bd_project_task_df | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_mtd/Common/bd/dws_disty_brpt_bd_mtd_v2.py` |
| (ETL join) | — | inner join (select * from ods_${country}.ods_etl_cust_xref_all_df | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_mtd/Common/bd/dws_disty_brpt_bd_mtd_v2.py` |
| (ETL join) | — | join (select * from ods_${country}.ods_etl_prog_cust_detail_df | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_mtd/Common/bd/dws_disty_brpt_bd_mtd_v2.py` |
| (ETL join) | — | join (select * from ods_${country}.ods_cis_corp_state_code | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_mtd/Common/bd/dws_disty_brpt_bd_mtd_v2.py` |
| (ETL join) | — | inner join (select * from ods_${country}.ods_cis_corp_addr_xref | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_mtd/Common/bd/dws_disty_brpt_bd_mtd_v2.py` |
| (ETL join) | — | INNER JOIN (select * from ods_${country}.ods_cis_corp_address | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_mtd/Common/bd/dws_disty_brpt_bd_mtd_v2.py` |
| (ETL join) | — | JOIN (select * from ods_${country}.ods_cis_corp_addr_profile | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_mtd/Common/bd/dws_disty_brpt_bd_mtd_v2.py` |
| (ETL join) | — | inner join (select * from ods_${country}.ods_etl_bd_project_task_df | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_mtd/Common/bd/dws_disty_brpt_bd_mtd_v2.py` |
| (ETL join) | — | inner join (select * from ods_${country}.ods_etl_bd_project_task_df | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_mtd/Common/bd/dws_disty_brpt_bd_mtd_v2.py` |
| (ETL join) | — | inner join (select * from ods_${country}.ods_etl_cust_xref_all_df | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_mtd/Common/bd/dws_disty_brpt_bd_mtd_v2.py` |
...
3. INSERT OVERWRITE into `dw_us.dws_disty_brpt_bd_mtd` partition `month_no`.
4. Sync to Vertica for B Report consumption (sync job not verified in this repository unless cited below).

```mermaid
flowchart LR
  dw_us_dws_disty_brpt_bd_mtd["dw_us.dws_disty_brpt_bd_mtd"]
  src0["1.1"]
  src0 --> dw_us_dws_disty_brpt_bd_mtd
  src1["1.2"]
  src1 --> dw_us_dws_disty_brpt_bd_mtd
  src2["1.3"]
  src2 --> dw_us_dws_disty_brpt_bd_mtd
  src3["1.4"]
  src3 --> dw_us_dws_disty_brpt_bd_mtd
  src4["1.filter"]
  src4 --> dw_us_dws_disty_brpt_bd_mtd
  src5["2.1"]
  src5 --> dw_us_dws_disty_brpt_bd_mtd
  src6["2.10"]
  src6 --> dw_us_dws_disty_brpt_bd_mtd
  src7["2.11"]
  src7 --> dw_us_dws_disty_brpt_bd_mtd
  consumers["B Report dashboards / DM serving"]
  dw_us_dws_disty_brpt_bd_mtd --> consumers
```
...
**Source:** intermediate aggregation inside ETL SQL — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_mtd/Common/bd/dws_disty_brpt_bd_mtd_v2.py`
...
|------|-------------|----------------|-----------|----------|--------------|
| **Query for reporting** | `dw_us.dws_disty_brpt_bd_mtd` | `dw_us.dws_disty_brpt_bd_mtd` | overwrite / incremental | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_mtd/Common/bd/dws_disty_brpt_bd_mtd_v2.py` | yes |
| **Hive alternative** | `dw_us.dws_disty_brpt_bd_mtd` | same as reporting table | — | ETL target table | — |
| **ETL internal** | `dw_us.dws_disty_brpt_bd_mtd` | n/a | INSERT OVERWRITE | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_mtd/Common/bd/dws_disty_brpt_bd_mtd_v2.py` | — |
...
|--------|-------|----------|
| `1.1` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_mtd/Common/bd/dws_disty_brpt_bd_mtd_v2.py` |
| `1.2` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_mtd/Common/bd/dws_disty_brpt_bd_mtd_v2.py` |
| `1.3` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_mtd/Common/bd/dws_disty_brpt_bd_mtd_v2.py` |
| `1.4` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_mtd/Common/bd/dws_disty_brpt_bd_mtd_v2.py` |
| `1.filter` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_mtd/Common/bd/dws_disty_brpt_bd_mtd_v2.py` |
| `2.1` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_mtd/Common/bd/dws_disty_brpt_bd_mtd_v2.py` |
| `2.10` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_mtd/Common/bd/dws_disty_brpt_bd_mtd_v2.py` |
| `2.11` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_mtd/Common/bd/dws_disty_brpt_bd_mtd_v2.py` |
| `2.12` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_mtd/Common/bd/dws_disty_brpt_bd_mtd_v2.py` |
| `2.2` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_mtd/Common/bd/dws_disty_brpt_bd_mtd_v2.py` |
| `2.3` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_mtd/Common/bd/dws_disty_brpt_bd_mtd_v2.py` |
| `2.4` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_mtd/Common/bd/dws_disty_brpt_bd_mtd_v2.py` |
| `2.5` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_mtd/Common/bd/dws_disty_brpt_bd_mtd_v2.py` |
| `2.6` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_mtd/Common/bd/dws_disty_brpt_bd_mtd_v2.py` |
| `2.7` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_mtd/Common/bd/dws_disty_brpt_bd_mtd_v2.py` |

#### Downstream consumers (verified)
| Object / script | Evidence |
|-----------------|----------|
| B Report dashboards / sibling DM tables | `source/contracts/b-report-us/tables/dws_disty_brpt_bd_mtd.md:L6` |

#### Operational detail (verified)
- Load pattern: INSERT OVERWRITE (partitioned) per ETL SQL — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_mtd/Common/bd/dws_disty_brpt_bd_mtd_v2.py:490`
- ETL script path: `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_mtd/Common/bd/dws_disty_brpt_bd_mtd_v2.py`
...
- `dws_disty_brpt_bd_mtd_v2.py` — primary Bitbucket ETL for `dws_disty_brpt_bd_mtd` — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_mtd/Common/bd/dws_disty_brpt_bd_mtd_v2.py`

---

*Document generated from `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_bd_mtd/Common/bd/dws_disty_brpt_bd_mtd_v2.py` with B Report contract enrichment when available.*
