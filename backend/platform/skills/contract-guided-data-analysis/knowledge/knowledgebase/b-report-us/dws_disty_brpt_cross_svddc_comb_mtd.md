# DWS: B Report combined-month profitability serving slice (cross_svddc_comb_mtd) (`dw_us.dws_disty_brpt_cross_svddc_comb_mtd`)
...
- layer_type: DWS
- source_kind: etl_sql
- evidence_source: source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py
- knowledgebase_path: target/knowledgebase/b-report-us/dws_disty_brpt_cross_svddc_comb_mtd.md
- contract_source: source/contracts/b-report-us/tables/dws_disty_brpt_cross_svddc_comb_mtd.md
...
- **Natural key:** `pm_dir_id`, `pm_vp_id`, `company_no`, `date_flag`, `month-to-date`, `cumulative`
- **Exclusions:** Non-US schemas, backup/temp table variants (`_bkp`, `_temp`), and non-shipped-order scenarios.

### Cross-engine presence
| Engine | Present | Canonical FQN | Notes |
|--------|---------|---------------|-------|
| Hive | yes | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd` | ETL target in Bitbucket script |
| Vertica | yes | `dw_us.dws_disty_brpt_cross_svddc_comb_mtd` | Contract marks Vertica verified |

### Physical schema reference
| Field | Value |
|-------|-------|
| **Authoritative catalog** | WKB L1 storage seed (not duplicated in this file) |
| **entity_id** | `dw_us.dws_disty_brpt_cross_svddc_comb_mtd` |
| **l1_catalog_seed** | `target/storage/wkb/snapshots/_snapshot_id_template/l1_catalog/vertica_dw_us_dws_disty_brpt_cross_svddc_comb_mtd.json` |
| **column_count** | 143 |
| **partition_keys** | `month_no` |
| **ddl_source** | B Report contract catalog and/or VERTICA/vcdisty DDL |
| **retrieval** | `python -m tools.wkb.indexing.run_query --query "b-report-us dws_disty_brpt_cross_svddc_comb_mtd schema" --intent find_table_schema` |

### Lineage
- **upstream:** ods_us.ods_cis_corp_cust_type, ods_us.ods_cis_corp_division, ods_us.ods_cis_corp_manager — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py`
- **downstream:** B Report DM/DWS serving and dashboards (per contract L6 when present) — `source/contracts/b-report-us/tables/dws_disty_brpt_cross_svddc_comb_mtd.md`
...
### Business purpose
B Report combined-month profitability serving slice (cross_svddc_comb_mtd)
...
|---------------|-----------|---------|----------|
| — | — | No explicit JOIN clauses parsed | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py` |
...
### End-to-end flow
1. Read upstream warehouse objects (ods_us.ods_cis_corp_cust_type, ods_us.ods_cis_corp_division, ods_us.ods_cis_corp_manager).
2. Apply CTE aggregations and business joins inside ETL SQL.
3. INSERT OVERWRITE into `dw_us.dws_disty_brpt_cross_svddc_comb_mtd` partition `month_no`.
4. Sync to Vertica for B Report consumption (sync job not verified in this repository unless cited below).

```mermaid
flowchart LR
  dw_us_dws_disty_brpt_cross_svddc_comb_mt["dw_us.dws_disty_brpt_cross_svddc_comb_mtd"]
  src0["ods_us.ods_cis_corp_cust_type"]
  src0 --> dw_us_dws_disty_brpt_cross_svddc_comb_mt
  src1["ods_us.ods_cis_corp_division"]
  src1 --> dw_us_dws_disty_brpt_cross_svddc_comb_mt
  src2["ods_us.ods_cis_corp_manager"]
  src2 --> dw_us_dws_disty_brpt_cross_svddc_comb_mt
  consumers["B Report dashboards / DM serving"]
  dw_us_dws_disty_brpt_cross_svddc_comb_mt --> consumers
```

### Base tables register
| Object | Role in this job |
|--------|------------------|
| `dw_us.dws_disty_brpt_cross_svddc_comb_mtd` | target |
...
|---------------|----------------|------------------|-----------------|----------------|----------|
| `month_no` | `table_dwd.month_no` | `month_no` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | passthrough | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:418` |
| `3` | `coalesce(table_dwd.cust_type,-3)` | `cust_type` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:420` |
| `cust_type_desc` | `table_cust_type.cust_type_descr` | `cust_type_descr` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | rename | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:421` |
| `division` | `coalesce(table_dwd.division, table_cust_type.division,-3)` | `division` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:422` |
| `division_desc` | `table_div.division_desc` | `division_desc` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | passthrough | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:423` |
| `3` | `nvl(table_dwd.pm_dir_id,-3)` | `pm_dir_id` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:425` |
| `pm_director_name` | `concat_ws(' ', table_manager3.firstname, table_manager3.lastname)` | `concat_ws`, `firstname`, `lastname` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | udf | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:426` |
| `3` | `nvl(table_dwd.pm_vp_id,-3)` | `pm_vp_id` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:427` |
| `pm_vp_name` | `concat_ws(' ', table_manager4.firstname, table_manager4.lastname)` | `concat_ws`, `firstname`, `lastname` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | udf | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:428` |
| `seg_code` | `table_dwd.seg_code` | `seg_code` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | passthrough | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:429` |
| `company_no` | `table_dwd.company_no` | `company_no` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | passthrough | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:430` |
| `0` | `nvl(table_dwd.d_sales,0)` | `d_sales` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:432` |
| `0` | `nvl(table_dwd.d_cost,0)` | `d_cost` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:433` |
| `0` | `nvl(table_dwd.d_unit,0)` | `d_unit` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:434` |
| `0` | `nvl(table_dwd.d_gm,0)` | `d_gm` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:435` |
| `0` | `nvl(table_dwd.d_ngm,0)` | `d_ngm` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:436` |
| `0` | `nvl(table_dwd.d_opl,0)` | `d_opl` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:437` |
| `0` | `nvl(table_dwd.d_scm_usage,0)` | `d_scm_usage` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:438` |
| `0` | `nvl(table_dwd.d_tgm,0)` | `d_tgm` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:439` |
| `0` | `nvl(table_dwd.d_cgp,0)` | `d_cgp` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:440` |
| `0` | `nvl(table_dwd.d_total_btl,0)` | `d_total_btl` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:441` |
| `0` | `nvl(table_dwd.w_sales,0)` | `w_sales` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:442` |
| `0` | `nvl(table_dwd.w_cost,0)` | `w_cost` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:443` |
| `0` | `nvl(table_dwd.w_unit,0)` | `w_unit` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:444` |
| `0` | `nvl(table_dwd.w_gm,0)` | `w_gm` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:445` |
| `0` | `nvl(table_dwd.w_ngm,0)` | `w_ngm` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:446` |
| `0` | `nvl(table_dwd.w_opl,0)` | `w_opl` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:447` |
| `0` | `nvl(table_dwd.w_scm_usage,0)` | `w_scm_usage` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:448` |
| `0` | `nvl(table_dwd.w_tgm,0)` | `w_tgm` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:449` |
| `0` | `nvl(table_dwd.w_cgp,0)` | `w_cgp` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:450` |
| `0` | `nvl(table_dwd.w_total_btl,0)` | `w_total_btl` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:451` |
| `0` | `nvl(table_dwd.m_sales,0)` | `m_sales` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:452` |
| `0` | `nvl(table_dwd.m_cost,0)` | `m_cost` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:453` |
| `0` | `nvl(table_dwd.m_unit,0)` | `m_unit` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:454` |
| `0` | `nvl(table_dwd.m_gm,0)` | `m_gm` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:455` |
| `0` | `nvl(table_dwd.m_ngm,0)` | `m_ngm` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:456` |
| `0` | `nvl(table_dwd.m_opl,0)` | `m_opl` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:457` |
| `0` | `nvl(table_dwd.m_scm_usage,0)` | `m_scm_usage` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:458` |
| `0` | `nvl(table_dwd.m_tgm,0)` | `m_tgm` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:459` |
| `0` | `nvl(table_dwd.m_scm_disc,0)` | `m_scm_disc` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:460` |
| `0` | `nvl(table_dwd.m_scm_ndisc,0)` | `m_scm_ndisc` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:461` |
| `0` | `nvl(table_dwd.m_ds_sales,0)` | `m_ds_sales` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:462` |
| `0` | `nvl(table_dwd.m_stock_sales,0)` | `m_stock_sales` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:463` |
| `0` | `nvl(table_dwd.m_ds_cost,0)` | `m_ds_cost` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:464` |
| `0` | `nvl(table_dwd.m_stock_cost,0)` | `m_stock_cost` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:465` |
| `0` | `nvl(table_dwd.m_ds_scm_usage,0)` | `m_ds_scm_usage` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:466` |
| `0` | `nvl(table_dwd.m_stock_scm_usage,0)` | `m_stock_scm_usage` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:467` |
| `0` | `nvl(table_dwd.m_cgp,0)` | `m_cgp` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:468` |
| `0` | `nvl(table_dwd.m_total_btl,0)` | `m_total_btl` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:469` |
| `0` | `nvl(table_dwd.pm_sales,0)` | `pm_sales` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:470` |
| `0` | `nvl(table_dwd.pm_cost,0)` | `pm_cost` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:471` |
| `0` | `nvl(table_dwd.pm_unit,0)` | `pm_unit` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:472` |
| `0` | `nvl(table_dwd.pm_gm,0)` | `pm_gm` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:473` |
| `0` | `nvl(table_dwd.pm_ngm,0)` | `pm_ngm` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:474` |
| `0` | `nvl(table_dwd.pm_opl,0)` | `pm_opl` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:475` |
| `0` | `nvl(table_dwd.pm_scm_usage,0)` | `pm_scm_usage` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:476` |
| `0` | `nvl(table_dwd.pm_tgm,0)` | `pm_tgm` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:477` |
| `0` | `nvl(table_dwd.pm_scm_disc,0)` | `pm_scm_disc` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:478` |
| `0` | `nvl(table_dwd.pm_scm_ndisc,0)` | `pm_scm_ndisc` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:479` |
| `0` | `nvl(table_dwd.pm_ds_sales,0)` | `pm_ds_sales` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:480` |
| `0` | `nvl(table_dwd.pm_stock_sales,0)` | `pm_stock_sales` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:481` |
| `0` | `nvl(table_dwd.pm_ds_cost,0)` | `pm_ds_cost` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:482` |
| `0` | `nvl(table_dwd.pm_stock_cost,0)` | `pm_stock_cost` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:483` |
| `0` | `nvl(table_dwd.pm_ds_scm_usage,0)` | `pm_ds_scm_usage` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:484` |
| `0` | `nvl(table_dwd.pm_stock_scm_usage,0)` | `pm_stock_scm_usage` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:485` |
| `0` | `nvl(table_dwd.pm_cgp,0)` | `pm_cgp` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:486` |
| `0` | `nvl(table_dwd.pm_total_btl,0)` | `pm_total_btl` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:487` |
| `0` | `nvl(table_dwd.ppm_sales,0)` | `ppm_sales` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:488` |
| `0` | `nvl(table_dwd.ppm_cost,0)` | `ppm_cost` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:489` |
| `0` | `nvl(table_dwd.ppm_unit,0)` | `ppm_unit` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:490` |
| `0` | `nvl(table_dwd.ppm_gm,0)` | `ppm_gm` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:491` |
| `0` | `nvl(table_dwd.ppm_ngm,0)` | `ppm_ngm` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:492` |
| `0` | `nvl(table_dwd.ppm_opl,0)` | `ppm_opl` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:493` |
| `0` | `nvl(table_dwd.ppm_scm_usage,0)` | `ppm_scm_usage` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:494` |
| `0` | `nvl(table_dwd.ppm_tgm,0)` | `ppm_tgm` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:495` |
| `0` | `nvl(table_dwd.ppm_scm_disc,0)` | `ppm_scm_disc` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:496` |
| `0` | `nvl(table_dwd.ppm_scm_ndisc,0)` | `ppm_scm_ndisc` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:497` |
| `0` | `nvl(table_dwd.ppm_ds_sales,0)` | `ppm_ds_sales` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:498` |
| `0` | `nvl(table_dwd.ppm_stock_sales,0)` | `ppm_stock_sales` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:499` |
| `0` | `nvl(table_dwd.ppm_ds_cost,0)` | `ppm_ds_cost` | `dw_${country}.dws_disty_brpt_cross_svddc_comb_mtd`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `ods_${country}.ods_cis_corp_manager` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:500` |
...
|------|--------|-----------------------------------------------------|
| 1 | `conf.get('date_flag')` | Business process date (comment: yesterday / @process_date) — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:14` |
| 2 | `conf.get('month_no')` | Fiscal month index used in SELECT/goal joins — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:26` |
| 3 | `conf.get('dt_month')` | Hive partition key `dt_month` (yyyy-MM derived from date_flag) — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:15` |
| — | `conf.get('end_day_of_last_month')` | Period anchor for comb_mtd wide columns — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:22` |
| — | `conf.get('week_begin_of_dateflag')` | Period anchor for comb_mtd wide columns — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:25` |
| — | `conf.get('end_day_of_same_month_of_last_year')` | Period anchor for comb_mtd wide columns — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:24` |
...
SELECT pm_dir_id, COUNT(*) AS row_cnt
FROM dw_us.dws_disty_brpt_cross_svddc_comb_mtd
WHERE month_no = '${partition_value}'
GROUP BY pm_dir_id
ORDER BY COUNT(*) DESC
...
SELECT pm_dir_id, pm_vp_id, company_no, month_no, COUNT(*) AS cnt
FROM dw_us.dws_disty_brpt_cross_svddc_comb_mtd
WHERE month_no = '${partition_value}'
GROUP BY pm_dir_id, pm_vp_id, company_no, month_no
HAVING COUNT(*) > 1;
```
...
|------|-------------|----------------|-----------|----------|--------------|
| **Query for reporting** | `dw_us.dws_disty_brpt_cross_svddc_comb_mtd` | `dw_us.dws_disty_brpt_cross_svddc_comb_mtd` | overwrite / incremental | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py` | yes |
| **Hive alternative** | `dw_us.dws_disty_brpt_cross_svddc_comb_mtd` | same as reporting table | — | ETL target table | — |
| **ETL internal** | `dw_us.dws_disty_brpt_cross_svddc_comb_mtd` | n/a | INSERT OVERWRITE | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py` | — |
...
|--------|-------|----------|
| `ods_us.ods_cis_corp_cust_type` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py` |
| `ods_us.ods_cis_corp_division` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py` |
| `ods_us.ods_cis_corp_manager` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py` |

#### Downstream consumers (verified)
| Object / script | Evidence |
|-----------------|----------|
| B Report dashboards / sibling DM tables | `source/contracts/b-report-us/tables/dws_disty_brpt_cross_svddc_comb_mtd.md:L6` |

#### Operational detail (verified)
- Load pattern: INSERT OVERWRITE (partitioned) per ETL SQL — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py:233`
- ETL script path: `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py`
...
- `dws_disty_brpt_cross_svddc_comb_mtd.py` — primary Bitbucket ETL for `dws_disty_brpt_cross_svddc_comb_mtd` — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py`

---

*Document generated from `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_cross_svddc_comb_mtd/Cross/python/dws_disty_brpt_cross_svddc_comb_mtd.py` with B Report contract enrichment when available.*
