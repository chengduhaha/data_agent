# DWS: B Report combined-month profitability serving slice (vpl_comb_mtd) (`dw_us.dws_disty_brpt_vpl_comb_mtd`)
...
- layer_type: DWS
- source_kind: etl_sql
- evidence_source: source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py
- knowledgebase_path: target/knowledgebase/b-report-us/dws_disty_brpt_vpl_comb_mtd.md
- contract_source: source/contracts/b-report-us/tables/dws_disty_brpt_vpl_comb_mtd.md
...
|--------|---------|---------------|-------|
| Hive | yes | `dw_${country}.dws_disty_brpt_vpl_comb_mtd` | ETL target in Bitbucket script |
| Vertica | yes | `dw_us.dws_disty_brpt_vpl_comb_mtd` | Contract marks Vertica verified |

### Physical schema reference
| Field | Value |
|-------|-------|
| **Authoritative catalog** | WKB L1 storage seed (not duplicated in this file) |
| **entity_id** | `dw_us.dws_disty_brpt_vpl_comb_mtd` |
| **l1_catalog_seed** | `target/storage/wkb/snapshots/_snapshot_id_template/l1_catalog/vertica_dw_us_dws_disty_brpt_vpl_comb_mtd.json` |
| **column_count** | 176 |
| **partition_keys** | `month_no` |
| **ddl_source** | B Report contract catalog and/or VERTICA/vcdisty DDL |
| **retrieval** | `python -m tools.wkb.indexing.run_query --query "b-report-us dws_disty_brpt_vpl_comb_mtd schema" --intent find_table_schema` |

### Lineage
- **upstream:** dim_us.dim_pub_vendor_info_df, dim_us.dim_pub_vpl_hierarchy_info_df, dim_us.dim_pub_vpl_info_df, ods_us.ods_etl_pm_vpc_matrix_df — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py`
- **downstream:** B Report DM/DWS serving and dashboards (per contract L6 when present) — `source/contracts/b-report-us/tables/dws_disty_brpt_vpl_comb_mtd.md`
...
### Business purpose
B Report combined-month profitability serving slice (vpl_comb_mtd)
...
|---------------|-----------|---------|----------|
| — | — | No explicit JOIN clauses parsed | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py` |
...
### End-to-end flow
1. Read upstream warehouse objects (dim_us.dim_pub_vendor_info_df, dim_us.dim_pub_vpl_hierarchy_info_df, dim_us.dim_pub_vpl_info_df, ods_us.ods_etl_pm_vpc_matrix_df).
2. Apply CTE aggregations and business joins inside ETL SQL.
3. INSERT OVERWRITE into `dw_us.dws_disty_brpt_vpl_comb_mtd` partition `month_no`.
4. Sync to Vertica for B Report consumption (sync job not verified in this repository unless cited below).

```mermaid
flowchart LR
  dw_us_dws_disty_brpt_vpl_comb_mtd["dw_us.dws_disty_brpt_vpl_comb_mtd"]
  src0["dim_us.dim_pub_vendor_info_df"]
  src0 --> dw_us_dws_disty_brpt_vpl_comb_mtd
  src1["dim_us.dim_pub_vpl_hierarchy_info_df"]
  src1 --> dw_us_dws_disty_brpt_vpl_comb_mtd
  src2["dim_us.dim_pub_vpl_info_df"]
  src2 --> dw_us_dws_disty_brpt_vpl_comb_mtd
  src3["ods_us.ods_etl_pm_vpc_matrix_df"]
  src3 --> dw_us_dws_disty_brpt_vpl_comb_mtd
  consumers["B Report dashboards / DM serving"]
  dw_us_dws_disty_brpt_vpl_comb_mtd --> consumers
```
...
| `dw_us.dws_disty_brpt_vpl_comb_mtd` | target |
...
|---------------|----------------|------------------|-----------------|----------------|----------|
| `month_no` | `table_dwd.month_no` | `month_no` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | passthrough | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:482` |
| `vpl_no` | `coalesce(table_dwd.vpl_no,-3)` | `vpl_no` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:483` |
| `vpl_code` | `table_vpl.vpl_code` | `vpl_code` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | passthrough | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:484` |
| `vpc_group_id` | `coalesce(table_dwd.vpc_group_id,table_vpl.vpc_group_id,-3)` | `vpc_group_id` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:485` |
| `vpc_group_desc` | `table_vpl.vpc_group_desc` | `vpc_group_desc` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | passthrough | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:486` |
| `vend_no` | `coalesce(table_dwd.vend_no,-3)` | `vend_no` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:487` |
| `vend_name` | `table_vend.vend_name` | `vend_name` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | passthrough | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:488` |
| `master_vend_no` | `coalesce(table_vend.master_vend_no,-3)` | `master_vend_no` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:489` |
| `master_vend_name` | `table_master_vend.cis_mk_name` | `cis_mk_name` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | rename | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:490` |
| `seg_code` | `table_dwd.seg_code` | `seg_code` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | passthrough | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:491` |
| `company_no` | `table_dwd.company_no` | `company_no` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | passthrough | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:492` |
| `0` | `nvl(table_dwd.goal_nsales,0)` | `goal_nsales` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:494` |
| `0` | `nvl(table_dwd.goal_gm,0)` | `goal_gm` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:495` |
| `0` | `nvl(table_dwd.goal_ngm,0)` | `goal_ngm` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:496` |
| `0` | `nvl(table_dwd.goal_opl_gm,0)` | `goal_opl_gm` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:497` |
| `0` | `nvl(table_dwd.goal_tgm,0)` | `goal_tgm` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:498` |
| `0` | `nvl(table_dwd.goal_dos,0)` | `goal_dos` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:499` |
| `0` | `nvl(table_dwd.goal_pdt,0)` | `goal_pdt` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:500` |
| `0` | `nvl(table_dwd.goal_total_btl,0)` | `goal_total_btl` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:501` |
| `0` | `nvl(table_dwd.d_sales,0)` | `d_sales` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:502` |
| `0` | `nvl(table_dwd.d_cost,0)` | `d_cost` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:503` |
| `0` | `nvl(table_dwd.d_unit,0)` | `d_unit` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:504` |
| `0` | `nvl(table_dwd.d_gm,0)` | `d_gm` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:505` |
| `0` | `nvl(table_dwd.d_ngm,0)` | `d_ngm` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:506` |
| `0` | `nvl(table_dwd.d_opl,0)` | `d_opl` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:507` |
| `0` | `nvl(table_dwd.d_scm_usage,0)` | `d_scm_usage` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:508` |
| `0` | `nvl(table_dwd.d_tgm,0)` | `d_tgm` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:509` |
| `0` | `nvl(table_dwd.d_cgp,0)` | `d_cgp` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:510` |
| `0` | `nvl(table_dwd.d_total_btl,0)` | `d_total_btl` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:511` |
| `0` | `nvl(table_dwd.w_sales,0)` | `w_sales` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:512` |
| `0` | `nvl(table_dwd.w_cost,0)` | `w_cost` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:513` |
| `0` | `nvl(table_dwd.w_unit,0)` | `w_unit` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:514` |
| `0` | `nvl(table_dwd.w_gm,0)` | `w_gm` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:515` |
| `0` | `nvl(table_dwd.w_ngm,0)` | `w_ngm` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:516` |
| `0` | `nvl(table_dwd.w_opl,0)` | `w_opl` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:517` |
| `0` | `nvl(table_dwd.w_scm_usage,0)` | `w_scm_usage` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:518` |
| `0` | `nvl(table_dwd.w_tgm,0)` | `w_tgm` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:519` |
| `0` | `nvl(table_dwd.w_cgp,0)` | `w_cgp` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:520` |
| `0` | `nvl(table_dwd.w_total_btl,0)` | `w_total_btl` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:521` |
| `0` | `nvl(table_dwd.m_sales,0)` | `m_sales` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:522` |
| `0` | `nvl(table_dwd.m_cost,0)` | `m_cost` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:523` |
| `0` | `nvl(table_dwd.m_unit,0)` | `m_unit` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:524` |
| `0` | `nvl(table_dwd.m_gm,0)` | `m_gm` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:525` |
| `0` | `nvl(table_dwd.m_ngm,0)` | `m_ngm` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:526` |
| `0` | `nvl(table_dwd.m_opl,0)` | `m_opl` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:527` |
| `0` | `nvl(table_dwd.m_scm_usage,0)` | `m_scm_usage` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:528` |
| `0` | `nvl(table_dwd.m_tgm,0)` | `m_tgm` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:529` |
| `0` | `nvl(table_dwd.m_scm_disc,0)` | `m_scm_disc` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:530` |
| `0` | `nvl(table_dwd.m_scm_ndisc,0)` | `m_scm_ndisc` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:531` |
| `0` | `nvl(table_dwd.m_ds_sales,0)` | `m_ds_sales` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:532` |
| `0` | `nvl(table_dwd.m_stock_sales,0)` | `m_stock_sales` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:533` |
| `0` | `nvl(table_dwd.m_ds_cost,0)` | `m_ds_cost` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:534` |
| `0` | `nvl(table_dwd.m_stock_cost,0)` | `m_stock_cost` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:535` |
| `0` | `nvl(table_dwd.m_ds_scm_usage,0)` | `m_ds_scm_usage` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:536` |
| `0` | `nvl(table_dwd.m_stock_scm_usage,0)` | `m_stock_scm_usage` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:537` |
| `0` | `nvl(table_dwd.m_cgp,0)` | `m_cgp` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:538` |
| `0` | `nvl(table_dwd.m_total_btl,0)` | `m_total_btl` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:539` |
| `0` | `nvl(table_dwd.pm_sales,0)` | `pm_sales` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:540` |
| `0` | `nvl(table_dwd.pm_cost,0)` | `pm_cost` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:541` |
| `0` | `nvl(table_dwd.pm_unit,0)` | `pm_unit` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:542` |
| `0` | `nvl(table_dwd.pm_gm,0)` | `pm_gm` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:543` |
| `0` | `nvl(table_dwd.pm_ngm,0)` | `pm_ngm` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:544` |
| `0` | `nvl(table_dwd.pm_opl,0)` | `pm_opl` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:545` |
| `0` | `nvl(table_dwd.pm_scm_usage,0)` | `pm_scm_usage` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:546` |
| `0` | `nvl(table_dwd.pm_tgm,0)` | `pm_tgm` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:547` |
| `0` | `nvl(table_dwd.pm_scm_disc,0)` | `pm_scm_disc` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:548` |
| `0` | `nvl(table_dwd.pm_scm_ndisc,0)` | `pm_scm_ndisc` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:549` |
| `0` | `nvl(table_dwd.pm_ds_sales,0)` | `pm_ds_sales` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:550` |
| `0` | `nvl(table_dwd.pm_stock_sales,0)` | `pm_stock_sales` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:551` |
| `0` | `nvl(table_dwd.pm_ds_cost,0)` | `pm_ds_cost` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:552` |
| `0` | `nvl(table_dwd.pm_stock_cost,0)` | `pm_stock_cost` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:553` |
| `0` | `nvl(table_dwd.pm_ds_scm_usage,0)` | `pm_ds_scm_usage` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:554` |
| `0` | `nvl(table_dwd.pm_stock_scm_usage,0)` | `pm_stock_scm_usage` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:555` |
| `0` | `nvl(table_dwd.pm_cgp,0)` | `pm_cgp` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:556` |
| `0` | `nvl(table_dwd.pm_total_btl,0)` | `pm_total_btl` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:557` |
| `0` | `nvl(table_dwd.ppm_sales,0)` | `ppm_sales` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:558` |
| `0` | `nvl(table_dwd.ppm_cost,0)` | `ppm_cost` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:559` |
| `0` | `nvl(table_dwd.ppm_unit,0)` | `ppm_unit` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:560` |
| `0` | `nvl(table_dwd.ppm_gm,0)` | `ppm_gm` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:561` |
| `0` | `nvl(table_dwd.ppm_ngm,0)` | `ppm_ngm` | `dw_${country}.dws_disty_brpt_vpl_comb_mtd`, `dim_${country}.dim_pub_vpl_info_df`, `dim_${country}.dim_pub_vendor_info_df`, `dim_${country}.dim_pub_vpl_hierarchy_info_df`, `ods_${country}.ods_etl_pm_vpc_matrix_df` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:562` |
...
|------|--------|-----------------------------------------------------|
| 1 | `conf.get('date_flag')` | Business process date (comment: yesterday / @process_date) — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:13` |
| 2 | `conf.get('month_no')` | Fiscal month index used in SELECT/goal joins — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:21` |
| 3 | `conf.get('dt_month')` | Hive partition key `dt_month` (yyyy-MM derived from date_flag) — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:14` |
| — | `conf.get('end_day_of_last_month')` | Period anchor for comb_mtd wide columns — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:17` |
| — | `conf.get('week_begin_of_dateflag')` | Period anchor for comb_mtd wide columns — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:20` |
| — | `conf.get('end_day_of_same_month_of_last_year')` | Period anchor for comb_mtd wide columns — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:19` |
...
|------|-------------|----------------|-----------|----------|--------------|
| **Query for reporting** | `dw_us.dws_disty_brpt_vpl_comb_mtd` | `dw_us.dws_disty_brpt_vpl_comb_mtd` | overwrite / incremental | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py` | yes |
| **Hive alternative** | `dw_us.dws_disty_brpt_vpl_comb_mtd` | same as reporting table | — | ETL target table | — |
| **ETL internal** | `dw_us.dws_disty_brpt_vpl_comb_mtd` | n/a | INSERT OVERWRITE | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py` | — |
...
|--------|-------|----------|
| `dim_us.dim_pub_vendor_info_df` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py` |
| `dim_us.dim_pub_vpl_hierarchy_info_df` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py` |
| `dim_us.dim_pub_vpl_info_df` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py` |
| `ods_us.ods_etl_pm_vpc_matrix_df` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py` |

#### Downstream consumers (verified)
| Object / script | Evidence |
|-----------------|----------|
| B Report dashboards / sibling DM tables | `source/contracts/b-report-us/tables/dws_disty_brpt_vpl_comb_mtd.md:L6` |

#### Operational detail (verified)
- Load pattern: INSERT OVERWRITE (partitioned) per ETL SQL — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py:263`
- ETL script path: `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py`
...
- `dws_disty_brpt_vpl_comb_mtd.py` — primary Bitbucket ETL for `dws_disty_brpt_vpl_comb_mtd` — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py`

---

*Document generated from `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_vpl_comb_mtd/Product/python/dws_disty_brpt_vpl_comb_mtd.py` with B Report contract enrichment when available.*
