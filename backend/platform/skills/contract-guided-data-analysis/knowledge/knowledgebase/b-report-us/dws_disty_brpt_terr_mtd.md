# DWS: B Report profitability serving aggregation (mtd) by business slice (`dw_us.dws_disty_brpt_terr_mtd`)
...
- layer_type: DWS
- source_kind: etl_sql
- evidence_source: source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py
- knowledgebase_path: target/knowledgebase/b-report-us/dws_disty_brpt_terr_mtd.md
- contract_source: source/contracts/b-report-us/tables/dws_disty_brpt_terr_mtd.md
...
|--------|---------|---------------|-------|
| Hive | yes | `dw_${country}.dws_disty_brpt_terr_mtd` | ETL target in Bitbucket script |
| Vertica | yes | `dw_us.dws_disty_brpt_terr_mtd` | Contract marks Vertica verified |

### Physical schema reference
| Field | Value |
|-------|-------|
| **Authoritative catalog** | WKB L1 storage seed (not duplicated in this file) |
| **entity_id** | `dw_us.dws_disty_brpt_terr_mtd` |
| **l1_catalog_seed** | `target/storage/wkb/snapshots/_snapshot_id_template/l1_catalog/vertica_dw_us_dws_disty_brpt_terr_mtd.json` |
| **column_count** | 141 |
| **partition_keys** | `month_no` |
| **ddl_source** | B Report contract catalog and/or VERTICA/vcdisty DDL |
| **retrieval** | `python -m tools.wkb.indexing.run_query --query "b-report-us dws_disty_brpt_terr_mtd schema" --intent find_table_schema` |

### Lineage
- **upstream:** dim_us.dim_pub_sales_mgr_dept_df, dim_us.dim_pub_sales_rep_terr_df, dim_us.dim_pub_sales_territory_df, dw_us.dwd_disty_sales_report_goal_view, dw_us.dws_disty_brpt_cust_mtd, ods_us.ods_cis_corp_cust_type — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py`
- **downstream:** B Report DM/DWS serving and dashboards (per contract L6 when present) — `source/contracts/b-report-us/tables/dws_disty_brpt_terr_mtd.md`
...
|---------------|-----------|---------|----------|
| (ETL join) | — | left join (select * from dim_${country}.dim_pub_sales_territory_df | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py` |
...
3. INSERT OVERWRITE into `dw_us.dws_disty_brpt_terr_mtd` partition `month_no`.
4. Sync to Vertica for B Report consumption (sync job not verified in this repository unless cited below).

```mermaid
flowchart LR
  dw_us_dws_disty_brpt_terr_mtd["dw_us.dws_disty_brpt_terr_mtd"]
  src0["dim_us.dim_pub_sales_mgr_dept_df"]
  src0 --> dw_us_dws_disty_brpt_terr_mtd
  src1["dim_us.dim_pub_sales_rep_terr_df"]
  src1 --> dw_us_dws_disty_brpt_terr_mtd
  src2["dim_us.dim_pub_sales_territory_df"]
  src2 --> dw_us_dws_disty_brpt_terr_mtd
  src3["dw_us.dwd_disty_sales_report_goal_view"]
  src3 --> dw_us_dws_disty_brpt_terr_mtd
  src4["dw_us.dws_disty_brpt_cust_mtd"]
  src4 --> dw_us_dws_disty_brpt_terr_mtd
  src5["ods_us.ods_cis_corp_cust_type"]
  src5 --> dw_us_dws_disty_brpt_terr_mtd
  src6["ods_us.ods_cis_corp_division"]
  src6 --> dw_us_dws_disty_brpt_terr_mtd
  src7["ods_us.ods_cis_corp_territory_group"]
  src7 --> dw_us_dws_disty_brpt_terr_mtd
  consumers["B Report dashboards / DM serving"]
  dw_us_dws_disty_brpt_terr_mtd --> consumers
```
...
| `dw_us.dws_disty_brpt_terr_mtd` | target |
...
**Source:** intermediate aggregation inside ETL SQL — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py`
...
| `company_no` | `coalesce(table_dws.company_no,table_goal.company_no)` | `company_no` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:221` |
| `0` | `nvl(table_dws.gross_sales,0)` | `gross_sales` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:222` |
| `0` | `nvl(table_dws.net_sales,0)` | `net_sales` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:223` |
| `0` | `nvl(table_dws.gross_cost,0)` | `gross_cost` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:224` |
| `0` | `nvl(table_dws.net_cost,0)` | `net_cost` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:225` |
| `0` | `nvl(table_dws.scm_usage,0)` | `scm_usage` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:226` |
| `0` | `nvl(table_dws.ds_sales,0)` | `ds_sales` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:227` |
| `0` | `nvl(table_dws.stock_sales,0)` | `stock_sales` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:228` |
| `0` | `nvl(table_dws.ds_cost,0)` | `ds_cost` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:229` |
| `0` | `nvl(table_dws.stock_cost,0)` | `stock_cost` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:230` |
| `0` | `nvl(table_dws.ds_scm_usage,0)` | `ds_scm_usage` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:231` |
| `0` | `nvl(table_dws.stock_scm_usage,0)` | `stock_scm_usage` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:232` |
| `0` | `nvl(table_dws.total_unit,0)` | `total_unit` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:233` |
| `0` | `nvl(table_dws.total_weight,0)` | `total_weight` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:234` |
| `0` | `nvl(table_dws.net_income,0)` | `net_income` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:235` |
| `0` | `nvl(table_dws.invest_capital,0)` | `invest_capital` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:236` |
| `0` | `nvl(table_dws.cgp,0)` | `cgp` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:237` |
| `0` | `nvl(table_dws.total_btl,0)` | `total_btl` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:238` |
| `0` | `nvl(table_dws.tgm_amt,0)` | `tgm_amt` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:239` |
| `0` | `nvl(table_dws.gm_amt,0)` | `gm_amt` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:240` |
| `0` | `nvl(table_dws.ngm_amt,0)` | `ngm_amt` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:241` |
| `0` | `nvl(table_dws.oplgm_amt,0)` | `oplgm_amt` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:242` |
| `0` | `nvl(table_dws.bo_gross_sales,0)` | `bo_gross_sales` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:243` |
| `0` | `nvl(table_dws.bo_gross_cost,0)` | `bo_gross_cost` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:244` |
| `0` | `nvl(table_dws.bo_total_unit,0)` | `bo_total_unit` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:245` |
| `0` | `nvl(table_dws.bo_gm_amt,0)` | `bo_gm_amt` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:246` |
| `0` | `nvl(table_dws.so_gross_sales,0)` | `so_gross_sales` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:247` |
| `0` | `nvl(table_dws.so_gross_cost,0)` | `so_gross_cost` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:248` |
| `0` | `nvl(table_dws.so_total_unit,0)` | `so_total_unit` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:249` |
| `0` | `nvl(table_dws.so_gm_amt,0)` | `so_gm_amt` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:250` |
| `0` | `nvl(table_dws.bo_age0_7,0)` | `bo_age0_7` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:251` |
| `0` | `nvl(table_dws.bo_age8_14,0)` | `bo_age8_14` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:252` |
| `0` | `nvl(table_dws.bo_age15_21,0)` | `bo_age15_21` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:253` |
| `0` | `nvl(table_dws.bo_age21_up,0)` | `bo_age21_up` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:254` |
| `0` | `nvl(table_dws.so_age0_7,0)` | `so_age0_7` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:255` |
| `0` | `nvl(table_dws.so_age8_14,0)` | `so_age8_14` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:256` |
| `0` | `nvl(table_dws.so_age15_21,0)` | `so_age15_21` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:257` |
| `0` | `nvl(table_dws.so_age21_up,0)` | `so_age21_up` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:258` |
| `0` | `nvl(table_dws.rr_unit,0)` | `rr_unit` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:259` |
| `0` | `nvl(table_dws.rr_sales,0)` | `rr_sales` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:260` |
| `0` | `nvl(table_dws.rr_cost,0)` | `rr_cost` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:261` |
| `0` | `nvl(table_dws.rr_gm,0)` | `rr_gm` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:262` |
| `0` | `nvl(table_dws.rr_ngm,0)` | `rr_ngm` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:263` |
| `0` | `nvl(table_dws.rr_opl,0)` | `rr_opl` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:264` |
| `0` | `nvl(table_dws.rr_cgp,0)` | `rr_cgp` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:265` |
| `0` | `nvl(table_dws.rr_total_btl,0)` | `rr_total_btl` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:266` |
| `0` | `nvl(table_dws.rr_tgm,0)` | `rr_tgm` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:267` |
| `0` | `nvl(table_dws.ap_finance,0)` | `ap_finance` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:268` |
| `0` | `nvl(table_dws.inv_cost,0)` | `inv_cost` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:269` |
| `0` | `nvl(table_dws.inv_reserve,0)` | `inv_reserve` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:270` |
| `0` | `nvl(table_dws.cr_risk_cterm,0)` | `cr_risk_cterm` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:271` |
| `0` | `nvl(table_dws.flr_synnex,0)` | `flr_synnex` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:272` |
| `0` | `nvl(table_dws.direct_credit,0)` | `direct_credit` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:273` |
| `0` | `nvl(table_dws.csgn_edi_fee,0)` | `csgn_edi_fee` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:274` |
| `0` | `nvl(table_dws.corporate,0)` | `corporate` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:275` |
| `0` | `nvl(table_dws.sfs,0)` | `sfs` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:276` |
| `0` | `nvl(table_dws.scm_risk,0)` | `scm_risk` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:277` |
| `0` | `nvl(table_dws.flr_vendor,0)` | `flr_vendor` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:278` |
| `0` | `nvl(table_dws.cust_finance_sales,0)` | `cust_finance_sales` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:279` |
| `0` | `nvl(table_dws.cust_pmt_disc,0)` | `cust_pmt_disc` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:280` |
| `0` | `nvl(table_dws.cvr_rm,0)` | `cvr_rm` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:281` |
| `0` | `nvl(table_dws.ar_fin_recovery,0)` | `ar_fin_recovery` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:282` |
| `0` | `nvl(table_dws.mfg_oh,0)` | `mfg_oh` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:283` |
| `0` | `nvl(table_dws.cust_finance,0)` | `cust_finance` | `table_dws`, `table_goal`, `ods_${country}.ods_cis_corp_cust_type`, `ods_${country}.ods_cis_corp_division`, `dim_${country}.dim_pub_sales_territory_df`, `dim_${country}.dim_pub_sales_rep_terr_df`, `dim_${country}.dim_pub_sales_mgr_dept_df`, `ods_${country}.ods_cis_corp_territory_sub_group`, `ods_${country}.ods_cis_corp_territory_group` | coalesce | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:284` |

_Showing 80 of 140 columns; full list in L3 `*_column_derivations.json` sidecar._
...
|------|--------|-----------------------------------------------------|
| 1 | `conf.get('date_flag')` | Business process date (comment: yesterday / @process_date) — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:10` |
| 3 | `conf.get('dt_month')` | Hive partition key `dt_month` (yyyy-MM derived from date_flag) — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:18` |
...
|------|-------------|----------------|-----------|----------|--------------|
| **Query for reporting** | `dw_us.dws_disty_brpt_terr_mtd` | `dw_us.dws_disty_brpt_terr_mtd` | overwrite / incremental | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py` | yes |
| **Hive alternative** | `dw_us.dws_disty_brpt_terr_mtd` | same as reporting table | — | ETL target table | — |
| **ETL internal** | `dw_us.dws_disty_brpt_terr_mtd` | n/a | INSERT OVERWRITE | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py` | — |
...
|--------|-------|----------|
| `dim_us.dim_pub_sales_mgr_dept_df` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py` |
| `dim_us.dim_pub_sales_rep_terr_df` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py` |
| `dim_us.dim_pub_sales_territory_df` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py` |
| `dw_us.dwd_disty_sales_report_goal_view` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py` |
| `dw_us.dws_disty_brpt_cust_mtd` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py` |
| `ods_us.ods_cis_corp_cust_type` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py` |
| `ods_us.ods_cis_corp_division` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py` |
| `ods_us.ods_cis_corp_territory_group` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py` |
| `ods_us.ods_cis_corp_territory_sub_group` | ETL source | `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py` |

#### Downstream consumers (verified)
| Object / script | Evidence |
|-----------------|----------|
| B Report dashboards / sibling DM tables | `source/contracts/b-report-us/tables/dws_disty_brpt_terr_mtd.md:L6` |

#### Operational detail (verified)
- Load pattern: INSERT OVERWRITE (partitioned) per ETL SQL — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py:203`
- ETL script path: `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py`
...
- `dws_disty_brpt_terr_mtd.py` — primary Bitbucket ETL for `dws_disty_brpt_terr_mtd` — `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py`

---

*Document generated from `source/contracts/b-report-us/bitbicket_etl/dws_disty_brpt_terr_mtd/Customer/python/dws_disty_brpt_terr_mtd.py` with B Report contract enrichment when available.*
