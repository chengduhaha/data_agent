...
2. Resolve using:
   ...
   - CIS timezone policy.
3. If no anchor exists **and** the relative time cue is genuinely ambiguous → ask a concise clarification; if the question already has a clear period elsewhere, do **not** ask.
